...
{
	/// <summary>
	/// <see c_ref="XAxis"/> inherits from <see c_ref="Axis"/>, and defines the
	/// special characteristics of a horizontal axis, specifically located at
	/// the bottom of the <see c_ref="Chart.Rect"/> of the <see c_ref="GraphPane"/>
	/// object
	/// </summary>
	/// 
	...
	public class XAxis : Axis, ICloneable, ISerializable
	{
		...
		/// default property values for the <see c_ref="XAxis"/> class.
		/// </summary>
		public new struct Default
		{
			// Default X Axis properties
			/// <summary>
			/// The default display mode for the <see c_ref="XAxis"/>
			...
			/// <see c_ref="XAxis"/>, that is, a line that
		...
		/// <summary>
		/// Default constructor that sets all <see c_ref="XAxis"/> properties to
		...
		#region Methods
		/// <summary>
		/// Setup the Transform Matrix to handle drawing of this <see c_ref="XAxis"/>
		/// </summary>
		/// <param name="g">
