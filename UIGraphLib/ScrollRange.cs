...
{
	/// <summary>
	/// A simple struct to store minimum and maximum <see c_ref="double" /> type
	...
	public struct ScrollRange
	{
		...
		/// <summary>
		/// Construct a <see c_ref="ScrollRange" /> object given the specified data values.
		/// </summary>
		...
		/// <summary>
		/// Sets the scroll range to default values of zero, and sets the <see c_ref="IsScrollable" />
		...
		/// <summary>
		/// Gets or sets a property that determines if the <see c_ref="Axis" /> corresponding to
		/// this <see c_ref="ScrollRange" /> object can be scrolled.
		/// </summary>
