...
namespace UIGraphLib
{
	...
	/// ArrowObj objects is maintained by the <see c_ref="GraphObjList"/> collection class.
	/// </summary>
	/// 
	...
	public class ArrowObj : LineObj, ICloneable, ISerializable
	{
		...
		/// Use the public property <see c_ref="Size"/> to access this value.
		/// </summary>
		private float _size;
		/// <summary>
		/// Private boolean field that stores the arrowhead state.
		/// Use the public property <see c_ref="IsArrowHead"/> to access this value.
		/// </summary>
		...
		/// default property values for the <see c_ref="ArrowObj"/> class.
		/// </summary>
		new public struct Default
		{
			/// <summary>
			/// The default size for the <see c_ref="ArrowObj"/> item arrowhead
			/// (<see c_ref="ArrowObj.Size"/> property).  Units are in points (1/72 inch).
			/// </summary>
			public static float Size = 12.0F;
			/// <summary>
			/// The default display mode for the <see c_ref="ArrowObj"/> item arrowhead
			/// (<see c_ref="ArrowObj.IsArrowHead"/> property).  true to show the
		...
		/// enabled or disabled with the <see c_ref="IsArrowHead"/> property.
		/// </remarks>
		...
		/// only</value>
		/// <seealso c_ref="Default.IsArrowHead"/>
		...
		#region Constructors
		/// <overloads>Constructors for the <see c_ref="ArrowObj"/> object</overloads>
		/// <summary>
		/// A constructor that allows the position, color, and size of the
		/// <see c_ref="ArrowObj"/> to be pre-specified.
		/// </summary>
		...
		/// </summary>
		/// <param name="x1">The x position of the starting point that defines the
		/// <see c_ref="ArrowObj"/>.  The units of this position are specified by the
		/// <see c_ref="Location.CoordinateFrame"/> property.</param>
		/// <param name="y1">The y position of the starting point that defines the
		/// <see c_ref="ArrowObj"/>.  The units of this position are specified by the
		/// <see c_ref="Location.CoordinateFrame"/> property.</param>
		...
		/// <summary>
		/// Default constructor -- places the <see c_ref="ArrowObj"/> at location
		...
		/// </summary>
		/// <param name="rhs">The <see c_ref="ArrowObj"/> object from which to copy</param>
