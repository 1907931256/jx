...
namespace UIGraphLib
{
	...
	/// <see c_ref="BarSettings.Base"/>, and the bars can be stacked or
	/// clustered, depending on the state of <see c_ref="BarSettings.Type"/>
	/// </remarks>
	...
	#region Fields
		/// <summary>
		/// Private field that stores a reference to the <see c_ref="ZedGraph.Bar"/>
		/// class defined for this <see c_ref="BarItem"/>.  Use the public
		/// property <see c_ref="Bar"/> to access this value.
		/// </summary>
		protected Bar			_bar;
	#endregion
	...
	#region Properties
		/// <summary>
		/// Gets a reference to the <see c_ref="ZedGraph.Bar"/> class defined
		/// for this <see c_ref="BarItem"/>.
		/// </summary>
		public Bar Bar
		{
			get { return _bar; }
