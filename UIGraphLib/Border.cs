...
{
	/// <summary>
	/// A class that encapsulates Border (frame) properties for an object.  The <see c_ref="Border"/> class
	...
	#region Fields
		...
		/// the actual rectangle area.  Use the public property <see c_ref="InflateFactor"/>
	...
	#region Defaults
		...
		{
			/// <summary>
			/// The default value for <see c_ref="Border.InflateFactor"/>, in units of points (1/72 inch).
			/// </summary>
			/// <seealso c_ref="Border.InflateFactor"/>
