...
namespace UIGraphLib
{
	...
	/// </summary>
	/// <remarks>The <see c_ref="ErrorBarItem"/> type is intended for displaying
	...
	/// The default symbol at each end of the "bar" is <see c_ref="SymbolType.HDash"/>,
	/// which creates an "I-Beam".  For horizontal bars
	/// (<see c_ref="ZedGraph.BarBase.Y"/> or
	/// <see c_ref="ZedGraph.BarBase.Y2"/>), you will need to change the symbol to
	/// <see c_ref="SymbolType.VDash"/> to get horizontal "I-Beams".
	/// Since the horizontal segments are actually symbols, their widths are
	/// controlled by the symbol size in <see c_ref="ZedGraph.ErrorBar.Symbol"/>,
	...
	#region Fields
		/// <summary>
		/// Private field that stores a reference to the <see c_ref="ZedGraph.ErrorBar"/>
		/// class defined for this <see c_ref="ErrorBarItem"/>.  Use the public
		/// property <see c_ref="ErrorBar"/> to access this value.
		/// </summary>
	...
	#region Properties
		/// <summary>
		/// Gets a reference to the <see c_ref="ZedGraph.ErrorBar"/> class defined
		/// for this <see c_ref="ErrorBarItem"/>.
		/// </summary>
		public ErrorBar Bar
		{
			get { return _bar; }
	...
	#region Methods
		/// <summary>
		/// Do all rendering associated with this <see c_ref="ErrorBarItem"/> to the specified
		...
		/// </param>
		/// <param name="pos">The ordinal position of the current <see c_ref="ErrorBarItem"/>
		/// curve.</param>
		...
		/// <summary>
		/// Draw a legend key entry for this <see c_ref="ErrorBarItem"/> at the specified location
		/// </summary>
		/// <param name="g">
		/// A graphic device object to be drawn into.  This is normally e.Graphics from the
		/// PaintEventArgs argument to the Paint() method.
