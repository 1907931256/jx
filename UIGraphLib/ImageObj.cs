...
namespace UIGraphLib
{
	...
	/// <see c_ref="GraphObj"/> objects is maintained by the <see c_ref="GraphObjList"/>
	/// collection class.
	/// </summary>
	/// 
	...
	#region Fields
		/// <summary>
		/// Private field that stores the image.  Use the public property <see c_ref="Image"/>
	...
	#region Defaults
		...
		/// default property values for the <see c_ref="ImageObj"/> class.
		/// </summary>
		new public struct Default
		{
			// Default text item properties
			/// <summary>
			/// Default value for the <see c_ref="ImageObj"/>
			/// <see c_ref="ImageObj.IsScaled"/> property.
			/// </summary>
	...
	#region Properties
		/// <summary>
		/// The <see c_ref="System.Drawing.Image"/> object.
		/// </summary>
        /// <value> A <see c_ref="System.Drawing.Image"/> class reference. </value>
		public Image Image
		{
			get { return _image; }
			set { _image = value; }
		...
		/// output rectangle (see <see c_ref="Location"/>).
		/// </summary>
		/// <value>true to scale the image, false to draw the image unscaled, but clipped
		/// to the destination rectangle</value>
	...
	#region Constructors
		/// <overloads>Constructors for the <see c_ref="ImageObj"/> object</overloads>
		/// <summary>
		/// A default constructor that places a null <see c_ref="System.Drawing.Image"/> at a
		/// default <see c_ref="RectangleF"/> of (0,0,1,1)
		/// </summary>
		public ImageObj() :
			this( null, 0, 0, 1, 1 )
		{
		...
		/// <summary>
		/// A constructor that allows the <see c_ref="System.Drawing.Image"/> and
		/// <see c_ref="RectangleF"/> location for the
		/// <see c_ref="ImageObj"/> to be pre-specified.
		/// </summary>
		/// <param name="image">A <see c_ref="System.Drawing.Image"/> class that defines
		/// the image</param>
		/// <param name="rect">A <see c_ref="RectangleF"/> struct that defines the
		...
		/// <summary>
		/// A constructor that allows the <see c_ref="System.Drawing.Image"/> and
		/// individual <see c_ref="System.Single"/> coordinate locations for the
		/// <see c_ref="ImageObj"/> to be pre-specified.
		/// </summary>
		/// <param name="image">A <see c_ref="System.Drawing.Image"/> class that defines
		/// the image</param>
		/// <param name="left">The position of the left side of the rectangle that defines the
		/// <see c_ref="ImageObj"/> location.  The units of this position are specified by the
		/// <see c_ref="Location.CoordinateFrame"/> property.</param>
	...
	#region Rendering Methods
		...
		/// <see c_ref="ArrowObj"/>.  The bounding box is calculated assuming a distance
