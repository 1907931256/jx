...
{
	/// <summary>
	/// This class handles the drawing of the curve <see c_ref="Symbol"/> objects.
	...
	#region Fields
        ...
        /// <see c_ref="Symbol"/> in points (1/72 inch).  Use the public
        /// property <see c_ref="Size"/> to access this value.
		/// </summary>
		private float		_size;
		/// <summary>
		/// Private field that stores the <see c_ref="SymbolType"/> for this
		/// <see c_ref="Symbol"/>.  Use the public
		/// property <see c_ref="Type"/> to access this value.
		/// </summary>
		...
		/// <see c_ref="Symbol"/>.  Use the public
		/// property <see c_ref="IsVisible"/> to access this value.  If this value is
		/// false, the symbols will not be shown (but the <see c_ref="Line"/> may
		/// still be shown).
		/// </summary>
		private bool		_isVisible;
		/// <summary>
		/// Private field that stores the <see c_ref="ZedGraph.Fill"/> data for this
		/// <see c_ref="Symbol"/>.  Use the public property <see c_ref="Fill"/> to
		/// access this value.
		/// </summary>
		private Fill		_fill;
		/// <summary>
		/// Private field that stores the <see c_ref="ZedGraph.Border"/> data for this
		/// <see c_ref="Symbol"/>.  Use the public property <see c_ref="Border"/> to
		/// access this value.
		/// </summary>
		private Border		_border;
		/// <summary>
		/// Private field that stores the user defined <see c_ref="GraphicsPath"/> data for this
		/// <see c_ref="Symbol"/>.  Use the public property <see c_ref="UserSymbol"/> to
		/// access this value.
		/// </summary>
	...
	#region Defaults
		...
		/// default property values for the <see c_ref="ZedGraph.Symbol"/> class.
		/// </summary>
		public struct Default
		{
			// Default Symbol properties
			/// <summary>
			/// The default size for curve symbols (<see c_ref="Symbol.Size"/> property),
			/// in units of points.
			/// </summary>
			...
			/// <summary>
			/// The default color for filling in this <see c_ref="Symbol"/>
			/// (<see c_ref="ZedGraph.Fill.Color"/> property).
			/// </summary>
			public static Color FillColor = Color.Red;
			/// <summary>
			/// The default custom brush for filling in this <see c_ref="Symbol"/>
			/// (<see c_ref="ZedGraph.Fill.Brush"/> property).
			/// </summary>
			public static Brush FillBrush = null;
			/// <summary>
			/// The default fill mode for the curve (<see c_ref="ZedGraph.Fill.Type"/> property).
			/// </summary>
			public static FillType FillType = FillType.None;
			/// <summary>
			/// The default symbol type for curves (<see c_ref="Symbol.Type"/> property).
			/// This is defined as a <see c_ref="ZedGraph.SymbolType"/> enumeration.
			/// </summary>
			public static SymbolType Type = SymbolType.Square;
			/// <summary>
			/// The default value for the <see c_ref="Symbol.IsAntiAlias"/>
			/// property.
			/// </summary>
			public static bool IsAntiAlias = false;
			/// <summary>
			/// The default display mode for symbols (<see c_ref="Symbol.IsVisible"/> property).
			/// true to display symbols, false to hide them.
			/// </summary>
			public static bool IsVisible = true;
			/// <summary>
			/// The default for drawing frames around symbols (<see c_ref="ZedGraph.LineBase.IsVisible"/> property).
			/// true to display symbol frames, false to hide them.
			/// </summary>
			public static bool IsBorderVisible = true;
			/// <summary>
			/// The default color for drawing symbols (<see c_ref="ZedGraph.LineBase.Color"/> property).
			/// </summary>
	...
	#region Properties
		/// <summary>
		/// Gets or sets the size of the <see c_ref="Symbol"/>
		/// </summary>
        /// <value>Size in points (1/72 inch)</value>
        /// <seealso c_ref="Default.Size"/>
		public float Size
		{
			get { return _size; }
			set { _size = value; }
		...
		/// <summary>
		/// Gets or sets the type (shape) of the <see c_ref="Symbol"/>
		/// </summary>
		/// <value>A <see c_ref="SymbolType"/> enum value indicating the shape</value>
		...
		/// this <see c_ref="Symbol" /> is drawn.  A value of false will leave the value of
		...
		/// <summary>
		/// Gets or sets a property that shows or hides the <see c_ref="Symbol"/>.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets the <see c_ref="ZedGraph.Border"/> data for this
		/// <see c_ref="Symbol"/>, which controls the border outline of the symbol.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets the <see c_ref="GraphicsPath"/> data for this
		/// <see c_ref="Symbol"/>, describing the user-defined symbol type.
		/// </summary>
		/// <remarks>
		/// This value only applies if <see c_ref="Symbol.Type">Symbol.Type</see>
		/// is <see c_ref="SymbolType.UserDefined">SymbolType.UserDefined</see>
		/// </remarks>
	...
	#region Constructors
		/// <summary>
		/// Default constructor that sets all <see c_ref="Symbol"/> properties to default
		...
		/// <summary>
		/// Default constructor that sets the <see c_ref="SymbolType"/> and
		/// <see c_ref="Color"/> as specified, and the remaining
		/// <see c_ref="Symbol"/> properties to default
		/// values as defined in the <see c_ref="Default"/> class.
		/// </summary>
		/// <param name="type">A <see c_ref="SymbolType"/> enum value
	...
	#region Rendering Methods
		...
		/// pixel units</param>
		/// <param name="path">A <see c_ref="GraphicsPath"/> previously constructed by
		/// <see c_ref="MakePath"/> for this symbol</param>
		/// <param name="pen">A <see c_ref="Pen"/> class representing the standard pen for this symbol</param>
		/// <param name="brush">A <see c_ref="Brush"/> class representing a default solid brush for this symbol
		/// If this symbol uses a <see c_ref="LinearGradientBrush"/>, it will be created on the fly for
		...
		/// <summary>
		/// Create a <see c_ref="GraphicsPath"/> struct for the current symbol based on the
