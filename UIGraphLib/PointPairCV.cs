...
namespace UIGraphLib
{
	...
	/// <see c_ref="PointPair" /> in that it maps the <see c_ref="ColorValue" /> property
	/// to an independent value.  That is, <see c_ref="ColorValue" /> and
	/// <see c_ref="PointPair.Z" /> are not related (as they are in the
	/// <see c_ref="PointPair" />).
	/// </summary>
