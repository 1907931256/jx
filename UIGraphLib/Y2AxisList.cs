...
namespace UIGraphLib
{
	...
	public class Y2AxisList : List<Y2Axis>, ICloneable
	{
		...
		/// </summary>
		/// <param name="rhs">The <see c_ref="Y2AxisList"/> object from which to copy</param>
		...
		/// <summary>
		/// Create a new <see c_ref="Y2Axis" /> and add it to this list.
		/// </summary>
		/// <param name="title">The title string for the new axis</param>
		/// <returns>An integer representing the ordinal position of the new <see c_ref="Y2Axis" /> in
		/// this <see c_ref="Y2AxisList" />.  This is the value that you would set the
		/// <see c_ref="CurveItem.YAxisIndex" /> property of a given <see c_ref="CurveItem" /> to 
		/// assign it to this new <see c_ref="Y2Axis" />.  Note that, for a <see c_ref="Y2Axis" />,
		/// you would also need to set the <see c_ref="CurveItem.IsY2Axis" /> property to true.</returns>
