...
namespace UIGraphLib
{
	...
	#region Constructors
		...
		/// Copy constructor
		/// </summary>
		/// <param name="rhs">The source <see c_ref="MinorGrid" /> to be copied.</param>
	...
	#region Properties
		...
		/// <summary>
		/// Gets or sets a value that determines if the major <see c_ref="Axis"/> gridlines
		/// (at each labeled value) will be visible
		/// </summary>
		/// <value>true to show the gridlines, false otherwise</value>
		/// <seealso c_ref="Default.IsVisible">Default.IsShowGrid</seealso>.
		/// <seealso c_ref="Color"/>
		/// <seealso c_ref="PenWidth"/>
		...
		/// <summary>
		/// The color to use for drawing this <see c_ref="Axis"/> grid.
		/// </summary>
	...
	#region Defaults
		...
		/// default property values for the <see c_ref="MinorGrid"/> class.
		/// </summary>
		public struct Default
		{
			/// <summary>
			/// The default "dash on" size for drawing the <see c_ref="Axis"/> minor grid
			/// (<see c_ref="MinorGrid.DashOn"/> property). Units are in points (1/72 inch).
			/// </summary>
			public static float DashOn = 1.0F;
			/// <summary>
			/// The default "dash off" size for drawing the <see c_ref="Axis"/> minor grid
			/// (<see c_ref="MinorGrid.DashOff"/> property). Units are in points (1/72 inch).
			/// </summary>
			public static float DashOff = 10.0F;
			/// <summary>
			/// The default pen width for drawing the <see c_ref="Axis"/> minor grid
			/// (<see c_ref="MinorGrid.PenWidth"/> property). Units are in points (1/72 inch).
			/// </summary>
			public static float PenWidth = 1.0F;
			/// <summary>
			/// The default color for the <see c_ref="Axis"/> minor grid lines
			/// (<see c_ref="MinorGrid.Color"/> property).  This color only affects the
			/// minor grid lines.
			/// </summary>
			public static Color Color = Color.Gray;

			/// <summary>
			/// The default display mode for the <see c_ref="Axis"/> minor grid lines
			/// (<see c_ref="MinorGrid.IsVisible"/> property). true
