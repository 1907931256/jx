...
namespace UIGraphLib
{
	...
	#region Button and Key Properties
		...
		/// </summary>
		/// <remarks>
		/// This value is combined with <see c_ref="ZoomModifierKeys"/> to determine the actual zoom combination.
		/// A secondary zoom button/key combination option is available via <see c_ref="ZoomButtons2"/> and
		/// <see c_ref="ZoomModifierKeys2"/>.  To not use this button/key combination, set the value
		/// of <see c_ref="ZoomButtons"/> to <see c_ref="MouseButtons.None"/>.
		/// </remarks>
		...
		/// </summary>
		/// <remarks>
		/// This value is combined with <see c_ref="ZoomModifierKeys2"/> to determine the actual zoom combination.
		/// The primary zoom button/key combination option is available via <see c_ref="ZoomButtons"/> and
		/// <see c_ref="ZoomModifierKeys"/>.  To not use this button/key combination, set the value
		/// of <see c_ref="ZoomButtons2"/> to <see c_ref="MouseButtons.None"/>.
		/// </remarks>
		[Bindable( true ), Category( "Display" ), NotifyParentProperty( true ),
		...
		/// </summary>
		/// <remarks>
		/// This value is combined with <see c_ref="ZoomButtons"/> to determine the actual zoom combination.
		/// A secondary zoom button/key combination option is available via <see c_ref="ZoomButtons2"/> and
		/// <see c_ref="ZoomModifierKeys2"/>.  To not use this button/key combination, set the value
		/// of <see c_ref="ZoomButtons"/> to <see c_ref="MouseButtons.None"/>.
		/// </remarks>
		...
		/// </summary>
		/// <remarks>
		/// This value is combined with <see c_ref="ZoomButtons2"/> to determine the actual zoom combination.
		/// A primary zoom button/key combination option is available via <see c_ref="ZoomButtons"/> and
		/// <see c_ref="ZoomModifierKeys"/>.  To not use this button/key combination, set the value
		/// of <see c_ref="ZoomButtons2"/> to <see c_ref="MouseButtons.None"/>.
		/// </remarks>
		[Bindable( true ), Category( "Display" ), NotifyParentProperty( true ),
		...
		/// </summary>
		/// <remarks>
		/// This value is combined with <see c_ref="PanModifierKeys"/> to determine the actual pan combination.
		/// A secondary pan button/key combination option is available via <see c_ref="PanButtons2"/> and
		/// <see c_ref="PanModifierKeys2"/>.  To not use this button/key combination, set the value
		/// of <see c_ref="PanButtons"/> to <see c_ref="MouseButtons.None"/>.
		/// </remarks>
		[Bindable( true ), Category( "Display" ), NotifyParentProperty( true ),
		 DefaultValue( MouseButtons.Left ),
		...
		/// </summary>
		/// <remarks>
		/// This value is combined with <see c_ref="PanModifierKeys2"/> to determine the actual pan combination.
		/// The primary pan button/key combination option is available via <see c_ref="PanButtons"/> and
		/// <see c_ref="PanModifierKeys"/>.  To not use this button/key combination, set the value
		/// of <see c_ref="PanButtons2"/> to <see c_ref="MouseButtons.None"/>.
		/// </remarks>
		[Bindable( true ), Category( "Display" ), NotifyParentProperty( true ),
		...
		/// </summary>
		/// <remarks>
		/// This value is combined with <see c_ref="PanButtons"/> to determine the actual pan combination.
		/// A secondary pan button/key combination option is available via <see c_ref="PanButtons2"/> and
		/// <see c_ref="PanModifierKeys2"/>.  To not use this button/key combination, set the value
		/// of <see c_ref="PanButtons"/> to <see c_ref="MouseButtons.None"/>.
		/// </remarks>
		...
		/// </summary>
		/// <remarks>
		/// This value is combined with <see c_ref="PanButtons2"/> to determine the actual pan combination.
		/// A primary pan button/key combination option is available via <see c_ref="PanButtons"/> and
		/// <see c_ref="PanModifierKeys"/>.  To not use this button/key combination, set the value
		/// of <see c_ref="PanButtons2"/> to <see c_ref="MouseButtons.None"/>.
		/// </remarks>
		[Bindable( true ), Category( "Display" ), NotifyParentProperty( true ),
		...
		/// <summary>
		/// Gets or sets a value that determines which Modifier keys will be used to 
		/// append a <see c_ref="CurveItem" /> to the selection list.
		/// </summary>
		[Bindable( true ), Category( "Display" ), NotifyParentProperty( true ),
		...
		/// <seealso c_ref="LinkEvent"/>
		// /// <seealso c_ref="ZedGraph.Web.IsImageMap"/>
		[Bindable( true ), Category( "Display" ), NotifyParentProperty( true ),
		 DefaultValue( MouseButtons.Left ),
	...
	#region Properties
		...
		/// <summary>
		/// Gets or sets the <see c_ref="ZedGraph.MasterPane"/> property for the control
		/// </summary>
		...
		*/
		...
		/// <summary>
		/// Gets or sets the <see c_ref="ZedGraph.GraphPane"/> property for the control
		/// </summary>
		/// <remarks>
		/// <see c_ref="ZedGraphControl"/> actually uses a <see c_ref="MasterPane"/> object
		/// to hold a list of <see c_ref="GraphPane"/> objects.  This property really only
		/// accesses the first <see c_ref="GraphPane"/> in the list.  If there is more
		/// than one <see c_ref="GraphPane"/>, use the <see c_ref="MasterPane"/>
		/// indexer property to access any of the <see c_ref="GraphPane"/> objects.</remarks>
		[
			Bindable( false ), Browsable( false ),
			DesignerSerializationVisibility( DesignerSerializationVisibility.Hidden )
		]
		...
		/// (such as <see c_ref="FontSpec.IsAntiAlias"/>)
		/// will be honored.
		/// </summary>
		[Bindable( true ), Category( "Display" ), NotifyParentProperty( true ),
		 DefaultValue( false ),
		...
		/// </summary>
		/// <remarks>The displayed values are taken from <see c_ref="PointPair.Tag"/>
		/// if it is a <see c_ref="System.String"/> type, or <see c_ref="PointPairBase.ToString()"/>
		/// otherwise (using the <see c_ref="PointValueFormat" /> as a format string).
		/// Additionally, the user can custom format the values using the
		/// <see c_ref="PointValueEvent" /> event.  Note that <see c_ref="IsShowPointValues" />
		/// may be overridden by <see c_ref="IsShowCursorValues" />.
		/// </remarks>
		[Bindable( true ), Category( "Display" ), NotifyParentProperty( true ),
		 DefaultValue( false ),
		...
		/// <see c_ref="Chart.Rect" />.
		/// </summary>
		/// <remarks>The displayed values are taken from the current mouse position, and formatted
		/// according to <see c_ref="PointValueFormat" /> and/or <see c_ref="PointDateFormat" />.  If this
		/// value is set to true, it overrides the <see c_ref="IsShowPointValues" /> setting.
		/// </remarks>
		[Bindable( true ), Category( "Display" ), NotifyParentProperty( true ),
		 DefaultValue( false ),
		...
		/// a given <see c_ref="CurveItem" /> to drag it to a new location.  The Mouse and Key
		/// combination for this mode are modifiable using <see c_ref="EditButtons" /> and
		/// <see c_ref="EditModifierKeys" />.
		/// </remarks>
		/// <seealso c_ref="EditButtons" />
		/// <seealso c_ref="EditModifierKeys" />
		/// <seealso c_ref="IsEnableVEdit" />
		[Bindable( true ), Category( "Display" ), NotifyParentProperty( true ),
		 DefaultValue( false ),
		...
		/// </summary>
		/// <remarks>
		/// Zooming is done by left-clicking inside the <see c_ref="Chart.Rect"/> to drag
		...
		/// while clicking the left mouse button) inside the <see c_ref="Chart.Rect"/> and
		/// dragging the mouse around to shift the scale ranges as desired.
		/// </remarks>
		/// <seealso c_ref="IsEnableVPan"/>
		[Bindable( true ), Category( "Display" ), NotifyParentProperty( true ),
		 DefaultValue( true ),
		...
		/// <see c_ref="ZedGraphControl"/>.  It provides options for Zoom, Pan, AutoScale, Clipboard
		/// Copy, and toggle <see c_ref="IsShowPointValues"/>.
		/// </remarks>
		...
		/// <summary>
		/// Gets or sets the <see c_ref="SaveFileDialog" /> instance that will be used
		/// by the "Save As..." context menu item.
		/// </summary>
		/// <remarks>
		/// This provides the opportunity to modify the dialog, such as setting the
		/// <see c_ref="FileDialog.InitialDirectory" /> property.
		/// </remarks>
		[Bindable( true ), Category( "Display" ), NotifyParentProperty( true ),
		 DefaultValue( true ),
		...
		/// <summary>
		/// Gets or sets a value that determines whether or not the <see c_ref="MasterPane" />
		...
		/// to the actual range of the data as returned by <see c_ref="CurveList.GetRange" /> at the
		/// time that <see c_ref="AxisChange" /> was last called.  Note that a value of true
		/// can override any setting of <see c_ref="ScrollMinX" />, <see c_ref="ScrollMaxX" />,
		/// <see c_ref="ScrollMinY" />, <see c_ref="ScrollMaxY" />, 
		/// <see c_ref="ScrollMinY2" />, and <see c_ref="ScrollMaxY2" />.  Note also that you must
		/// call <see c_ref="AxisChange" /> from the <see c_ref="ZedGraphControl" /> for this to
		/// work properly (e.g., don't call it directly from the <see c_ref="GraphPane" />.
		/// Alternatively, you can call <see c_ref="SetScrollRangeFromData" /> at anytime to set
		/// the scroll bar range.<br />
		/// <b>In most cases, you will probably want to disable
		/// <see c_ref="ZedGraph.GraphPane.IsBoundedRanges" /> before activating this option.</b>
		/// </remarks>
		[Bindable( true ), Category( "Display" ), NotifyParentProperty( true ),
		 DefaultValue( false ),
		...
		/// <see c_ref="IsAutoScrollRange" /> is true.
		/// </summary>
		/// <remarks>
		...
		/// clicking directly on it and dragging (see <see c_ref="IsEnableHPan"/> and <see c_ref="IsEnableVPan"/>).
		/// You can control the available range of scrolling with the <see c_ref="ScrollMinX"/> and
		/// <see c_ref="ScrollMaxX"/> properties.  Note that the scroll range can be set automatically by
		/// <see c_ref="IsAutoScrollRange" />.<br />
		/// <b>In most cases, you will probably want to disable
		/// <see c_ref="ZedGraph.GraphPane.IsBoundedRanges" /> before activating this option.</b>
		/// </remarks>
		...
		/// Another option is display panning, in which the user can move the display around by
		/// clicking directly on it and dragging (see <see c_ref="IsEnableHPan"/> and <see c_ref="IsEnableVPan"/>).
		/// You can control the available range of scrolling with the <see c_ref="ScrollMinY"/> and
		/// <see c_ref="ScrollMaxY"/> properties.
		/// Note that the vertical scroll bar only affects the <see c_ref="YAxis"/>; it has no impact on
		/// the <see c_ref="Y2Axis"/>.  The panning options affect both the <see c_ref="YAxis"/> and
		/// <see c_ref="Y2Axis"/>.  Note also that the scroll range can be set automatically by
		/// <see c_ref="IsAutoScrollRange" />.<br />
		/// <b>In most cases, you will probably want to disable
		/// <see c_ref="ZedGraph.GraphPane.IsBoundedRanges" /> before activating this option.</b>
		/// </remarks>
		...
		/// <summary>
		/// Gets or sets a value that determines if the <see c_ref="XAxis" /> <see c_ref="Scale" />
		/// ranges for all <see c_ref="GraphPane" /> objects in the <see c_ref="MasterPane" /> will
		/// be forced to match.
		/// </summary>
		/// <remarks>
		/// If set to true (default is false), then all of the <see c_ref="GraphPane" /> objects
		/// in the <see c_ref="MasterPane" /> associated with this <see c_ref="ZedGraphControl" />
		...
		/// <summary>
		/// Gets or sets a value that determines if the <see c_ref="YAxis" /> <see c_ref="Scale" />
		/// ranges for all <see c_ref="GraphPane" /> objects in the <see c_ref="MasterPane" /> will
		/// be forced to match.
		/// </summary>
		/// <remarks>
		...
		/// the <see c_ref="ScrollMinY2" /> and <see c_ref="ScrollMaxY2" /> values are not set to the
		/// same proportions as <see c_ref="ScrollMinY" /> and <see c_ref="ScrollMaxY" /> with respect
		/// to the actual <see c_ref="Scale.Min"/> and <see c_ref="Scale.Max" />.  Also note that
		/// this property is actually just an alias to the <see c_ref="ScrollRange.IsScrollable" />
		/// property of the first element of <see c_ref="YScrollRangeList" />.
		/// </remarks>
		/// <seealso c_ref="IsShowVScrollBar"/>
		/// <seealso c_ref="ScrollMinY2"/>
		/// <seealso c_ref="ScrollMaxY2"/>
		/// <seealso c_ref="YScrollRangeList" />
		/// <seealso c_ref="Y2ScrollRangeList" />
		[Bindable( true ), Category( "Display" ), NotifyParentProperty( true ),
		 DefaultValue( false ),
		...
		/// <summary>
		/// Access the <see c_ref="ScrollRangeList" /> for the Y axes.
		/// </summary>
		/// <remarks>
		/// This list maintains the user scale ranges for the scroll bars for each axis
		/// in the <see c_ref="ZedGraph.GraphPane.YAxisList" />.  Each ordinal location in
		/// <see c_ref="YScrollRangeList" /> corresponds to an equivalent ordinal location
		/// in <see c_ref="ZedGraph.GraphPane.YAxisList" />.
		/// </remarks>
		/// <seealso c_ref="ScrollMinY" />
		/// <seealso c_ref="ScrollMaxY" />
		[Bindable( true ), Category( "Display" ), NotifyParentProperty( true )]
		...
		/// <summary>
		/// Access the <see c_ref="ScrollRangeList" /> for the Y2 axes.
		/// </summary>
		/// <remarks>
		/// This list maintains the user scale ranges for the scroll bars for each axis
		/// in the <see c_ref="ZedGraph.GraphPane.Y2AxisList" />.  Each ordinal location in
		/// <see c_ref="Y2ScrollRangeList" /> corresponds to an equivalent ordinal location
		/// in <see c_ref="ZedGraph.GraphPane.Y2AxisList" />.
		/// </remarks>
		/// <seealso c_ref="ScrollMinY2" />
		/// <seealso c_ref="ScrollMaxY2" />
		[Bindable( true ), Category( "Display" ), NotifyParentProperty( true )]
		...
		/// <see c_ref="Scale.Min"/> value to be set to <see c_ref="ScrollMinX"/>.  Note that this
		/// value applies only to the scroll bar settings.  Axis panning (see <see c_ref="IsEnableHPan"/>)
		/// is not affected by this value.  Note that this value can be overridden by
		/// <see c_ref="IsAutoScrollRange" /> and <see c_ref="SetScrollRangeFromData" />.
		/// </remarks>
		...
		/// <see c_ref="Scale.Max"/> value to be set to <see c_ref="ScrollMaxX"/>.  Note that this
		/// value applies only to the scroll bar settings.  Axis panning (see <see c_ref="IsEnableHPan"/>)
		/// is not affected by this value.  Note that this value can be overridden by
		/// <see c_ref="IsAutoScrollRange" /> and <see c_ref="SetScrollRangeFromData" />.
		/// </remarks>
		...
		/// <remarks>
		/// Effectively, the minimum endpoint of the scroll range will cause the
		/// <see c_ref="Scale.Min"/> value to be set to <see c_ref="ScrollMinY"/>.  Note that this
		/// value applies only to the scroll bar settings.  Axis panning (see <see c_ref="IsEnableVPan"/>)
		/// is not affected by this value.  Note that this value can be overridden by
		/// <see c_ref="IsAutoScrollRange" /> and <see c_ref="SetScrollRangeFromData" />.  Also note that
		/// this property is actually just an alias to the <see c_ref="ScrollRange.Min" />
		/// property of the first element of <see c_ref="YScrollRangeList" />.
		/// </remarks>
		/// <value>A double value indicating the minimum axis value</value>
		/// <seealso c_ref="YScrollRangeList" />
		...
		/// <remarks>
		/// Effectively, the maximum endpoint of the scroll range will cause the
		/// <see c_ref="Scale.Max"/> value to be set to <see c_ref="ScrollMaxY"/>.  Note that this
		/// value applies only to the scroll bar settings.  Axis panning (see <see c_ref="IsEnableVPan"/>)
		/// is not affected by this value.  Note that this value can be overridden by
		/// <see c_ref="IsAutoScrollRange" /> and <see c_ref="SetScrollRangeFromData" />.  Also note that
		/// this property is actually just an alias to the <see c_ref="ScrollRange.Max" />
		/// property of the first element of <see c_ref="YScrollRangeList" />.
		/// </remarks>
		/// <value>A double value indicating the maximum axis value</value>
		/// <seealso c_ref="YScrollRangeList" />
		...
		/// <remarks>
		/// Effectively, the minimum endpoint of the scroll range will cause the
		/// <see c_ref="Scale.Min"/> value to be set to <see c_ref="ScrollMinY2"/>.  Note that this
		/// value applies only to the scroll bar settings.  Axis panning (see <see c_ref="IsEnableVPan"/>)
		/// is not affected by this value.  Note that this value can be overridden by
		/// <see c_ref="IsAutoScrollRange" /> and <see c_ref="SetScrollRangeFromData" />.  Also note that
		/// this property is actually just an alias to the <see c_ref="ScrollRange.Min" />
		/// property of the first element of <see c_ref="Y2ScrollRangeList" />.
		/// </remarks>
		/// <value>A double value indicating the minimum axis value</value>
		/// <seealso c_ref="Y2ScrollRangeList" />
		[Bindable( true ), Category( "Display" ), NotifyParentProperty( true ),
		...
		/// <remarks>
		/// Effectively, the maximum endpoint of the scroll range will cause the
		/// <see c_ref="Scale.Max"/> value to be set to <see c_ref="ScrollMaxY2"/>.  Note that this
		/// value applies only to the scroll bar settings.  Axis panning (see <see c_ref="IsEnableVPan"/>)
		/// is not affected by this value.  Note that this value can be overridden by
		/// <see c_ref="IsAutoScrollRange" /> and <see c_ref="SetScrollRangeFromData" />.  Also note that
		/// this property is actually just an alias to the <see c_ref="ScrollRange.Max" />
		...
		/// </summary>
		/// <remarks>
		/// Use the <see c_ref="System.Globalization.NumberFormatInfo" /> type
		...
		/// </summary>
		/// <remarks>
		/// Use the <see c_ref="System.Globalization.DateTimeFormatInfo" /> type
		/// to determine the format strings.
		/// </remarks>
		[Bindable( true ), Category( "Display" ), NotifyParentProperty( true ),
		...
		/// <seealso c_ref="Bitmap"/>
		/// </summary>
		/// <exception c_ref="ZedGraphException">
		...
		public Image GetImage()
		{
			lock ( this )
			{
				if ( BeenDisposed || _masterPane == null || _masterPane[0] == null )
					throw new GraphException( "The control has been disposed" );
