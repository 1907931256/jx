...
{
	/// <summary>
	/// A class that captures all the scale range settings for a <see c_ref="GraphPane"/>.
	/// </summary>
	/// <remarks>
	/// This class is used to store scale ranges in order to allow zooming out to
	/// prior scale range states.  <see c_ref="ZoomState"/> objects are maintained in the
	/// <see c_ref="ZoomStateStack"/> collection.  The <see c_ref="ZoomState"/> object holds
	/// a <see c_ref="ScaleState"/> object for each of the three axes; the <see c_ref="XAxis"/>,
	/// the <see c_ref="YAxis"/>, and the <see c_ref="Y2Axis"/>.
	/// </remarks>
	...
	public class ZoomState : ICloneable
	{
		...
		{
			/// <summary>
			/// Indicates the <see c_ref="ZoomState"/> object is from a Zoom operation
			/// </summary>
			Zoom,
			/// <summary>
			/// Indicates the <see c_ref="ZoomState"/> object is from a Wheel Zoom operation
			/// </summary>
			WheelZoom,
			/// <summary>
			/// Indicates the <see c_ref="ZoomState"/> object is from a Pan operation
			/// </summary>
			Pan,
			/// <summary>
			/// Indicates the <see c_ref="ZoomState"/> object is from a Scroll operation
			/// </summary>
			Scroll
		}

		/// <summary>
		/// <see c_ref="ScaleState"/> objects to store the state data from the axes.
		/// </summary>
		...
		/// <summary>
		/// Gets a <see c_ref="StateType" /> value indicating the type of action (zoom or pan)
		/// saved by this <see c_ref="ZoomState" />.
		/// </summary>
		...
		/// <summary>
		/// Copy the properties from this <see c_ref="ZoomState"/> out to the specified <see c_ref="GraphPane"/>.
		/// </summary>
		/// <param name="pane">The <see c_ref="GraphPane"/> to which the scale range properties should be
		/// copied.</param>
		...
		/// <summary>
		/// Determine if the state contained in this <see c_ref="ZoomState"/> object is different from
		/// the state of the specified <see c_ref="GraphPane"/>.
		/// </summary>
		/// <param name="pane">The <see c_ref="GraphPane"/> object with which to compare states.</param>
