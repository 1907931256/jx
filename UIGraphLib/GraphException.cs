...
{
	/// <summary>
	/// An exception thrown by ZedGraph.  A child class of <see c_ref="ApplicationException"/>.
	/// </summary>
	///
	...
	public class GraphException : System.ApplicationException
	{
		...
		/// </summary>
		/// <param name="info">The <see c_ref="System.Runtime.Serialization.SerializationInfo"/>
		...
		/// <summary>
		/// Initializes a new instance of the <see c_ref="Exception"/> class with a specified
