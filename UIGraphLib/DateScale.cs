...
{
	/// <summary>
	/// The DateScale class inherits from the <see c_ref="Scale" /> class, and implements
	/// the features specific to <see c_ref="AxisType.Date" />.
	/// </summary>
	/// <remarks>
	/// DateScale is a cartesian axis with calendar dates or times.  The actual data values should
	/// be created with the <see c_ref="XDate" /> type, which is directly translatable to a
	/// <see c_ref="System.Double" /> type for storage in the point value arrays.
	/// </remarks>
	/// 
	...
	#region properties
		...
		/// </summary>
		/// <remarks>
		/// The set property is specifically adapted for <see c_ref="AxisType.Date" /> scales,
	...
	#region methods
		...
		/// </summary>
		/// <remarks>
		/// This method only applies to <see c_ref="AxisType.Date"/> type axes, and it
		...
		/// Note that the <see c_ref="Scale.MajorStep"/> property setting can have multiple unit
		/// types (<see c_ref="Scale.MajorUnit"/> and <see c_ref="Scale.MinorUnit" />),
		/// but the <see c_ref="Scale.Min"/> and
		/// <see c_ref="Scale.Max"/> units are always days (<see c_ref="XDate"/>).  This
		...
		/// </param>
		/// <seealso c_ref="Scale.PickScale"/>
		/// <seealso c_ref="AxisType.Date"/>
		/// <seealso c_ref="Scale.MajorUnit"/>
		/// <seealso c_ref="Scale.MinorUnit"/>
		...
		/// <see c_ref="Scale.MajorUnit"/> for a <see c_ref="AxisType.Date"/> scale.
		/// This method is used by <see c_ref="PickScale"/>.
		/// </summary>
		...
		/// <see c_ref="Scale.MajorStep" /> to match the units of <see c_ref="Scale.Min" />
		/// and <see c_ref="Scale.Max" />.  This reflects the setting of
		/// <see c_ref="Scale.MajorUnit" />.
		/// </remarks>
		...
		/// <see c_ref="Scale.MinorStep" /> to match the units of <see c_ref="Scale.Min" />
		/// and <see c_ref="Scale.Max" />.  This reflects the setting of
		/// <see c_ref="Scale.MinorUnit" />.
		/// </remarks>
