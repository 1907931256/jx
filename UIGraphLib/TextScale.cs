...
{
	/// <summary>
	/// The TextScale class inherits from the <see c_ref="Scale" /> class, and implements
	/// the features specific to <see c_ref="AxisType.Text" />.
	/// </summary>
	/// <remarks>
	...
	#region methods
		...
		/// </summary>
		/// <remarks>
		/// This method only applies to <see c_ref="AxisType.Text"/> type axes, and it
		/// is called by the general <see c_ref="PickScale"/> method.  This is an ordinal
		...
		/// determined by <see c_ref="Scale.Default.MaxTextLabels"/>.  If necessary, this method will
		/// set the <see c_ref="Scale.MajorStep"/> value to greater than 1.0 in order to keep the total
		/// labels displayed below <see c_ref="Scale.Default.MaxTextLabels"/>.  For example, a
		/// <see c_ref="Scale.MajorStep"/> size of 2.0 would only display every other label on the
		/// axis.  The <see c_ref="Scale.MajorStep"/> value calculated by this routine is always
		...
		/// <summary>
		/// Make a value label for an <see c_ref="AxisType.Text" /> <see c_ref="Axis" />.
		/// </summary>
		/// <param name="pane">
