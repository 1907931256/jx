...
namespace UIGraphLib
{
	...
	#region Member variables
		...
		/// for <see c_ref="HiLowBarItem"/> and <see c_ref="ErrorBarItem" /> charts.
		/// </summary>
		public double Z;

		/// <summary>
		/// A tag object for use by the user.  This can be used to store additional
		/// information associated with the <see c_ref="PointPair"/>.  ZedGraph never
		/// modifies this value, but if it is a <see c_ref="String"/> type, it
		/// may be displayed in a <see c_ref="System.Windows.Forms.ToolTip"/>
		/// within the <see c_ref="ZedGraphControl"/> object.
		/// </summary>
		/// <remarks>
	...
	#region Constructors
		...
		/// <param name="x">This pair's x coordinate.</param>
		/// <param name="y">This pair's y coordinate.</param>
		/// <param name="label">This pair's string label (<see c_ref="Tag"/>)</param>
		...
		/// <param name="y">This pair's y coordinate.</param>
		/// <param name="z">This pair's z or lower dependent coordinate.</param>
		/// <param name="tag">This pair's <see c_ref="Tag"/> property</param>
		...
		/// <summary>
		/// Creates a point pair from the specified <see c_ref="PointF"/> struct.
		/// </summary>
		/// <param name="pt">The <see c_ref="PointF"/> struct from which to get the
		/// new <see c_ref="PointPair"/> values.</param>
	...
	#region Properties
		...
		/// This is really just an alias for <see c_ref="PointPair.Z"/>.
		/// </summary>
		...
		/// <summary>
		/// The ColorValue property is just an alias for the <see c_ref="PointPair.Z" />
		/// property.
		/// </summary>
		/// <remarks>
		/// For other types, such as the <see c_ref="StockPt"/>, the <see c_ref="StockPt" />
		/// can be mapped to a unique value.  This is used with the
		/// <see c_ref="FillType.GradientByColorValue" /> option.
		/// </remarks>
	...
	#region Inner classes
		...
		public class PointPairComparerY : IComparer
		{
			...
			/// <summary>
			/// Compares two <see c_ref="PointPair"/>s.
			/// </summary>
