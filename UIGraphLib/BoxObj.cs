...
namespace UIGraphLib
{
	...
	/// the graph.  A list of
	/// BoxObj objects is maintained by the <see c_ref="GraphObjList"/> collection class.
	/// </summary>
	/// 
	...
	#region Fields
		...
		/// <see c_ref="BoxObj"/>.  Use the public property <see c_ref="Fill"/> to
		/// access this value.
		/// </summary>
	...
	#region Defaults
		...
		{
			/// <summary>
			/// The default pen width used for the <see c_ref="BoxObj"/> border
            /// (<see c_ref="ZedGraph.LineBase.Width"/> property).  Units are points (1/72 inch).
            /// </summary>
			public static float PenWidth = 1.0F;
			/// <summary>
			/// The default color used for the <see c_ref="BoxObj"/> border
			/// (<see c_ref="ZedGraph.LineBase.Color"/> property).
			/// </summary>
			public static Color BorderColor = Color.Black;
			/// <summary>
			/// The default color used for the <see c_ref="BoxObj"/> fill
	...
	#region Properties
		...
		/// <summary>
		/// Gets or sets the <see c_ref="ZedGraph.Border"/> object, which
	...
	#region Constructors
		/// <overloads>Constructors for the <see c_ref="BoxObj"/> object</overloads>
		/// <summary>
		...
		/// <summary>
		/// A default constructor that creates a <see c_ref="BoxObj"/> using a location of (0,0),
