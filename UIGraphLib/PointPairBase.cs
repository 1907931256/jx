...
namespace UIGraphLib
{
	...
	/// </summary>
	/// <remarks>
	/// This class is typically a base class for actual <see c_ref="PointPair" /> type implementations.
	/// </remarks>
	/// 
	...
	#region Properties
		...
		/// </summary>
		/// <remarks>The value is considered invalid if it is <see c_ref="PointPairBase.Missing"/>,
		/// <see c_ref="Double.PositiveInfinity"/>, <see c_ref="Double.NegativeInfinity"/>
		/// or <see c_ref="Double.NaN"/>.</remarks>
	...
	#region Methods
		...
		/// <summary>
		/// Compare two <see c_ref="PointPairBase"/> objects for equality.  To be equal, X and Y
		/// must be exactly the same between the two objects.
		/// </summary>
		/// <param name="obj">The <see c_ref="PointPairBase"/> object to be compared with.</param>
		/// <returns>true if the <see c_ref="PointPairBase"/> objects are equal, false otherwise</returns>
		...
		/// Example:  a format string of "e2" would give "( 1.23e+001, -1.69e+001 )".
		/// The Z value is not displayed (see <see c_ref="PointPair.ToString( string, string, string )"/>).
		/// </summary>
