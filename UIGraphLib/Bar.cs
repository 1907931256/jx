...
namespace UIGraphLib
{
   ...
   public class Bar : ICloneable, ISerializable
   {
	#region Fields
		...
		/// <see c_ref="Bar"/>.  Use the public property <see c_ref="Fill"/> to
		/// access this value.
		/// </summary>
		private Fill  _fill;
		/// <summary>
		/// Private field that stores the <see c_ref="Border"/> class that defines the
		/// properties of the border around this <see c_ref="BarItem"/>. Use the public
	...
	#region Defaults
		...
		/// default property values for the <see c_ref="Bar"/> class.
		/// </summary>
		public struct Default
		{
			...
			/// <summary>
			/// The default fill mode for bars (<see c_ref="ZedGraph.Fill.Type"/> property).
			/// </summary>
			public static FillType FillType = FillType.Brush;
			/// <summary>
			/// The default border mode for bars (<see c_ref="ZedGraph.LineBase.IsVisible"/> property).
	...
	#region Constructors
		/// <summary>
		/// Default constructor that sets all <see c_ref="Bar"/> properties to default
	...
	#region Properties
		/// <summary>
		/// The <see c_ref="Border"/> object used to draw the border around the <see c_ref="Bar"/>.
		/// </summary>
		/// <seealso c_ref="Default.IsBorderVisible"/>
		/// <seealso c_ref="Default.BorderWidth"/>
