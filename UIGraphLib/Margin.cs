...
namespace UIGraphLib
{
	...
	public class Margin : ICloneable, ISerializable
	{
		...
		/// kept blank.  Use the public properties <see c_ref="Margin.Left"/>, <see c_ref="Margin.Right"/>,
		/// <see c_ref="Margin.Top"/>, <see c_ref="Margin.Bottom"/> to access these values.
		/// </summary>
	...
	#region Constructors
		...
		/// <summary>
		/// Constructor to build a <see c_ref="Margin" /> from the default values.
		/// </summary>
		public Margin()
		{
			_left = Default.Left;
		...
		/// Copy constructor
		/// </summary>
		/// <param name="rhs">the <see c_ref="Margin" /> instance to be copied.</param>
	...
	#region Properties
		...
		/// <see c_ref="PaneBase.Rect"/> rectangle and the features of the graph.
		/// </summary>
		/// <value>This value is in units of points (1/72 inch), and is scaled
		/// linearly with the graph size.</value>
		/// <seealso c_ref="Default.Left"/>
		/// <seealso c_ref="PaneBase.IsFontsScaled"/>
		/// <seealso c_ref="Right"/>
		/// <seealso c_ref="Top"/>
		/// <seealso c_ref="Bottom"/>
		public float Left
		{
			get { return _left; }
			set { _left = value; }
	...
	#region Defaults
		...
		/// <summary>
		/// A simple struct that defines the default property values for the <see c_ref="Margin"/> class.
		/// </summary>
		public class Default
		{
			/// <summary>
			/// The default value for the <see c_ref="Margin.Left"/> property, which is
			/// the size of the space on the left side of the <see c_ref="PaneBase.Rect"/>.
			/// </summary>
			/// <value>Units are points (1/72 inch)</value>
			public static float Left = 10.0F;
			/// <summary>
			/// The default value for the <see c_ref="Margin.Right"/> property, which is
			/// the size of the space on the right side of the <see c_ref="PaneBase.Rect"/>.
			/// </summary>
			/// <value>Units are points (1/72 inch)</value>
			public static float Right = 10.0F;
			/// <summary>
			/// The default value for the <see c_ref="Margin.Top"/> property, which is
			/// the size of the space on the top side of the <see c_ref="PaneBase.Rect"/>.
			/// </summary>
			/// <value>Units are points (1/72 inch)</value>
			public static float Top = 10.0F;
			/// <summary>
			/// The default value for the <see c_ref="Margin.Bottom"/> property, which is
			/// the size of the space on the bottom side of the <see c_ref="PaneBase.Rect"/>.
			/// </summary>
			/// <value>Units are points (1/72 inch)</value>
