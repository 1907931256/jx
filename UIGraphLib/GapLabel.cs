...
namespace UIGraphLib
{
	...
	/// properties.  Inherits from <see c_ref="Label" />, and adds the <see c_ref="Gap" />
	/// property for use by the <see c_ref="Axis" /> and <see c_ref="PaneBase" /> objects.
	/// </summary>
	/// 
	...
	#region Constructors
		...
		/// <summary>
		/// Constructor to build a <see c_ref="GapLabel" /> from the text and the
		...
		/// Copy constructor
		/// </summary>
		/// <param name="rhs">the <see c_ref="AxisLabel" /> instance to be copied.</param>
	...
	#region Properties
		...
		/// <summary>
		/// Gets or sets the gap factor between this label and the opposing <see c_ref="Axis" />
		/// or <see c_ref="Chart" />.
		/// </summary>
		/// <remarks>
		/// This value is expressed as a fraction of the character height for the <see c_ref="GapLabel" />.
		/// </remarks>
		public float Gap
		{
			get { return _gap; }
		...
		/// <summary>
		/// Calculate the size of the <see c_ref="Gap" /> based on the <see c_ref="Label.FontSpec" />
	...
	#region Default
		...
		/// default property values for the <see c_ref="GapLabel"/> class.
		/// </summary>
		public struct Default
		{
			/// <summary>
			/// The default <see c_ref="GapLabel.Gap" /> setting.
			/// </summary>
