...
namespace UIGraphLib
{
	...
	public class GasGaugeRegion : CurveItem, ICloneable, ISerializable
	{
		...
		/// <summary>
		/// Defines the minimum value of this <see c_ref="GasGaugeRegion"/>
		/// </summary>
		private double _minValue;

		/// <summary>
		/// Defines the maximum value of this <see c_ref="GasGaugeRegion"/>
		/// </summary>
		private double _maxValue;

		/// <summary>
		/// Defines the Color of this <see c_ref="GasGaugeRegion"/>
		/// </summary>
		private Color _color;

		/// <summary>
		/// Internally calculated; Start angle of this pie that defines this <see c_ref="GasGaugeRegion"/>
		/// </summary>
		private float _startAngle;

		/// <summary>
		/// Internally calculated; Sweep angle of this pie that defines this <see c_ref="GasGaugeRegion"/>
		/// </summary>
		private float _sweepAngle;

		/// <summary>
		/// Private	field	that stores the	<see c_ref="ZedGraph.Fill"/> data for this
		/// <see c_ref="GasGaugeRegion"/>.	 Use the public property <see	c_ref="Fill"/> to
		/// access this value.
		/// </summary>
		private Fill _fill;
		...
		/// <see c_ref="GasGaugeRegion"/>
		/// </summary>
		private TextObj _labelDetail;

		/// <summary>
		/// Private	field	that stores the	<see c_ref="Border"/> class that defines	the
		/// properties of the	border around	this <see c_ref="GasGaugeRegion"/>. Use the public
		/// property	<see c_ref="Border"/> to access this value.
		/// </summary>
		private Border _border;

		/// <summary>
		/// The bounding rectangle for this <see c_ref="GasGaugeRegion"/>.
		/// </summary>
		private RectangleF _boundingRectangle;

		/// <summary>
		/// Private field to hold the GraphicsPath of this <see c_ref="GasGaugeRegion"/> to be
		...
		/// <summary>
		/// Gets or sets the SlicePath of this <see c_ref="GasGaugeRegion"/>
		/// </summary>
		...
		/// <summary>
		/// Gets or sets the LabelDetail of this <see c_ref="GasGaugeRegion"/>
		/// </summary>
		...
		/// <summary>
		/// Gets or sets the Border of this <see c_ref="GasGaugeRegion"/>
		/// </summary>
		...
		/// <summary>
		/// Gets or sets the RegionColor of this <see c_ref="GasGaugeRegion"/>
		/// </summary>
		...
		/// <summary>
		/// Gets or sets the Fill of this <see c_ref="GasGaugeRegion"/>
		/// </summary>
		public Fill Fill
		{
			get { return _fill; }
		...
		/// <summary>
		/// Gets or sets the SweepAngle of this <see c_ref="GasGaugeRegion"/>
		/// </summary>
		...
		/// <summary>
		/// Gets or sets the StartAngle of this <see c_ref="GasGaugeRegion"/>
		/// </summary>
		...
		/// <summary>
		/// Gets or sets the MinValue of this <see c_ref="GasGaugeRegion"/>
		/// </summary>
		...
		/// <summary>
		/// Gets or sets the MaxValue of this <see c_ref="GasGaugeRegion"/>
		/// </summary>
	...
	#region Defaults
		...
		/// <summary>
		/// Specify the default property values for the <see c_ref="GasGaugeRegion"/> class.
		/// </summary>
		public struct Default
		{
			/// <summary>
			/// The default border pen width for the <see c_ref="GasGaugeRegion"/>
			/// </summary>
			public static float BorderWidth = 1.0F;

			/// <summary>
			/// The default fill type for the <see c_ref="GasGaugeRegion"/>
			/// </summary>
			public static FillType FillType = FillType.Brush;

			/// <summary>
			/// The default value for the visibility of the <see c_ref="GasGaugeRegion"/> border.
			/// </summary>
			public static bool IsBorderVisible = true;

			/// <summary>
			/// The default value for the color of the <see c_ref="GasGaugeRegion"/> border
			/// </summary>
			public static Color BorderColor = Color.Gray;

			/// <summary>
			/// The default value for the color of the <see c_ref="GasGaugeRegion"/> fill
			/// </summary>
			public static Color FillColor = Color.Empty;

			/// <summary>
			/// The default value for the fill brush of the <see c_ref="GasGaugeRegion"/>
			/// </summary>
			public static Brush FillBrush = null;

			/// <summary>
			/// The default value for the visibility of the <see c_ref="GasGaugeRegion"/> fill.
			/// </summary>
...
//			public static PieLabelType LabelType = PieLabelType.Name;
			...
			/// <summary>
			/// The default value for the font size of the <see c_ref="GasGaugeRegion"/> labels.
			/// </summary>
	...
	#region Methods
		...
		/// <summary>
		/// Render the label for this <see c_ref="GasGaugeRegion"/>.
		/// </summary>
		/// <param name="g">
		/// A graphic device object to be drawn into. This is normally e.Graphics from the
		/// PaintEventArgs argument to the Paint() method.
		...
		/// PaintEventArgs argument to the Paint() method.
		/// </param>
		/// <param name="rect">Bounding rectangle for this <see c_ref="GasGaugeRegion"/>.</param>
		/// <param name="scaleFactor">
		/// The scaling factor to be used for rendering objects. This is calculated and
		/// passed down by the parent <see c_ref="ZedGraph.GraphPane"/> object using the
		/// <see c_ref="PaneBase.CalcScaleFactor"/> method, and is used to proportionally adjust
