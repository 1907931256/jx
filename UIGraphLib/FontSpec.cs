...
{
	/// <summary>
	/// The <see c_ref="FontSpec"/> class is a generic font class that maintains the font family,
	...
	/// <see c_ref="AlignH"/> and <see c_ref="AlignV"/> parameters in the
	/// <see c_ref="Draw(Graphics,PaneBase,string,float,float,AlignH,AlignV,float)"/> method.
	/// </summary>
	/// 
	...
	#region Fields
		...
		/// <see c_ref="FontSpec"/>.  Use the public property <see c_ref="FontColor"/>
		/// to access this value.
		/// </summary>
		/// <value>A system <see c_ref="System.Drawing.Color"/> reference.</value>
		private Color _fontColor;
		/// <summary>
		/// Private field that stores the font family name for this <see c_ref="FontSpec"/>.
		/// Use the public property <see c_ref="Family"/> to access this value.
		/// </summary>
		/// <value>A text string with the font family name, e.g., "Arial"</value>
		private string _family;
		/// <summary>
		/// Private field that determines whether this <see c_ref="FontSpec"/> is
		/// drawn with bold typeface.
		/// Use the public property <see c_ref="IsBold"/> to access this value.
		/// </summary>
		...
		/// Use the public property <see c_ref="IsItalic"/> to access this value.
		/// </summary>
		...
		/// Use the public property <see c_ref="IsUnderline"/> to access this value.
		/// </summary>
		...
		/// <see c_ref="FontSpec"/>.  Use the public property <see c_ref="Fill"/> to
		/// access this value.
		/// </summary>
		private Fill _fill;
		/// <summary>
		/// Private field that determines the properties of the border around the text.
		/// Use the public property <see c_ref="Border"/> to access this value.
		/// </summary>
		private Border _border;

		/// <summary>
		/// Private field that determines the angle at which this
		/// <see c_ref="FontSpec"/> object is drawn.  Use the public property
		/// <see c_ref="Angle"/> to access this value.
		/// </summary>
		...
		/// <see c_ref="FontSpec"/> object is drawn.  This alignment really only
		/// affects multi-line strings.  Use the public property
		/// <see c_ref="StringAlignment"/> to access this value.
		/// </summary>
		/// <value>A <see c_ref="StringAlignment"/> enumeration.</value>
		private StringAlignment _stringAlignment;

		/// <summary>
		/// Private field that determines the size of the font for this
		/// <see c_ref="FontSpec"/> object.  Use the public property
		/// <see c_ref="Size"/> to access this value.
		/// </summary>
		/// <value>The size of the font, measured in points (1/72 inch).</value>
		private float _size;

		/// <summary>
		/// Private field that stores a reference to the <see c_ref="Font"/>
		/// object for this <see c_ref="FontSpec"/>.  This font object will be at
		/// the actual drawn size <see c_ref="_scaledSize"/> according to the current
		/// size of the <see c_ref="GraphPane"/>.  Use the public method
		/// <see c_ref="GetFont"/> to access this font object.
		/// </summary>
		/// <value>A reference to a <see c_ref="Font"/> object</value>
		private Font _font;

		/// <summary>
		/// Private field that determines if the <see c_ref="FontSpec" /> will be
		/// displayed using anti-aliasing logic.
		/// Use the public property <see c_ref="IsAntiAlias" /> to access this value.
		/// </summary>
		private bool _isAntiAlias;
		/// <summary>
		/// Private field that determines if the <see c_ref="FontSpec" /> will be
		/// displayed with a drop shadow.
		/// Use the public property <see c_ref="IsDropShadow" /> to access this value.
		/// </summary>
		private bool _isDropShadow;
		/// <summary>
		/// Private field that determines the color of the dropshadow for this
		/// <see c_ref="FontSpec" />.
		/// Use the public property <see c_ref="DropShadowColor" /> to access this value.
		/// </summary>
		private Color _dropShadowColor;
		/// <summary>
		/// Private field that determines the offset angle of the dropshadow for this
		/// <see c_ref="FontSpec" />.
		/// Use the public property <see c_ref="DropShadowAngle" /> to access this value.
		/// </summary>
		private float _dropShadowAngle;
		/// <summary>
		/// Private field that determines the offset distance of the dropshadow for this
		/// <see c_ref="FontSpec" />.
		/// Use the public property <see c_ref="DropShadowOffset" /> to access this value.
		/// </summary>
		...
		/// fraction of the <see c_ref="FontSpec"/> <see c_ref="_scaledSize"/>,
		/// based on the value of <see c_ref="Default.SuperSize"/>.  This
		...
		/// <see c_ref="FontSpec"/> object.  This represents the actual on-screen
		/// size, rather than the <see c_ref="Size"/> that represents the reference
		/// size for a "full-sized" <see c_ref="GraphPane"/>.
		/// </summary>
		/// <value>The size of the font, measured in points (1/72 inch).</value>
	...
	#region Defaults
		...
		/// default property values for the <see c_ref="FontSpec"/> class.
		/// </summary>
		public struct Default
		{
			...
			/// <summary>
			/// The default custom brush for filling in this <see c_ref="FontSpec"/>
			/// (<see c_ref="ZedGraph.Fill.Brush"/> property).
			/// </summary>
			public static Brush FillBrush = null;
			/// <summary>
			/// The default fill mode for this <see c_ref="FontSpec"/>
			...
			/// <summary>
			/// Default value for <see c_ref="FontSpec.IsDropShadow"/>, which determines
			/// if the drop shadow is displayed for this <see c_ref="FontSpec" />.
			/// </summary>
			public static bool IsDropShadow = false;
			/// <summary>
			/// Default value for <see c_ref="FontSpec.IsAntiAlias"/>, which determines
			/// if anti-aliasing logic is used for this <see c_ref="FontSpec" />.
			/// </summary>
			public static bool IsAntiAlias = false;
			/// <summary>
			/// Default value for <see c_ref="FontSpec.DropShadowColor"/>, which determines
			/// the color of the drop shadow for this <see c_ref="FontSpec" />.
			/// </summary>
			public static Color DropShadowColor = Color.Black;
			/// <summary>
			/// Default value for <see c_ref="FontSpec.DropShadowAngle"/>, which determines
			/// the offset angle of the drop shadow for this <see c_ref="FontSpec" />.
			/// </summary>
			public static float DropShadowAngle = 45f;
			/// <summary>
			/// Default value for <see c_ref="FontSpec.DropShadowOffset"/>, which determines
			/// the offset distance of the drop shadow for this <see c_ref="FontSpec" />.
			/// </summary>
	...
	#region Properties
		/// <summary>
		/// The color of the font characters for this <see c_ref="FontSpec"/>.
		/// Note that the border and background
		/// colors are set using the <see c_ref="ZedGraph.LineBase.Color"/> and
		/// <see c_ref="ZedGraph.Fill.Color"/> properties, respectively.
		/// </summary>
		/// <value>A system <see c_ref="System.Drawing.Color"/> reference.</value>
		...
		/// <summary>
		/// The font family name for this <see c_ref="FontSpec"/>.
		/// </summary>
		/// <value>A text string with the font family name, e.g., "Arial"</value>
		...
		/// <summary>
		/// Determines whether this <see c_ref="FontSpec"/> is
		/// drawn with bold typeface.
		/// </summary>
		/// <value>A boolean value, true for bold, false for normal</value>
		public bool IsBold
		...
		/// <summary>
		/// The angle at which this <see c_ref="FontSpec"/> object is drawn.
		/// </summary>
		/// <value>The angle of the font, measured in anti-clockwise degrees from
		/// horizontal.  Negative values are permitted.</value>
		public float Angle
		...
		/// <summary>
		/// The size of the font for this <see c_ref="FontSpec"/> object.
		/// </summary>
		/// <value>The size of the font, measured in points (1/72 inch).</value>
		public float Size
		{
		...
		/// <summary>
		/// Gets or sets the <see c_ref="Border"/> class used to draw the border border
		/// around this text.
		/// </summary>
		...
		/// <see c_ref="FontSpec"/>, which controls how the background
		...
		/// <summary>
		/// Gets or sets a value that determines if the <see c_ref="FontSpec" /> will be
		/// drawn using anti-aliasing logic within GDI+.
		/// </summary>
		/// <remarks>
		/// If this property is set to true, it will override the current setting of
		/// <see c_ref="Graphics.SmoothingMode" /> by setting the value temporarily to
		/// <see c_ref="SmoothingMode.HighQuality" />.  If this property is set to false,
		/// the the current setting of <see c_ref="Graphics.SmoothingMode" /> will be
		/// left as-is.
		/// </remarks>
		...
		/// displayed with a drop shadow.
		/// </summary>
		/// <seealso c_ref="DropShadowColor" />
		/// <seealso c_ref="DropShadowAngle" />
		/// <seealso c_ref="DropShadowOffset" />
		...
		/// <summary>
		/// Gets or sets the color of the drop shadow for this <see c_ref="FontSpec" />.
		/// </summary>
		/// <remarks>
		/// This value only applies if <see c_ref="IsDropShadow" /> is true.
		/// </remarks>
		/// <seealso c_ref="IsDropShadow" />
		/// <seealso c_ref="DropShadowAngle" />
		/// <seealso c_ref="DropShadowOffset" />
		...
		/// <summary>
		/// Gets or sets the offset angle of the drop shadow for this <see c_ref="FontSpec" />.
		/// </summary>
		/// <remarks>
		/// This value only applies if <see c_ref="IsDropShadow" /> is true.
		/// </remarks>
		...
		/// <summary>
		/// Gets or sets the offset distance of the drop shadow for this <see c_ref="FontSpec" />.
		/// </summary>
		/// <remarks>
		/// This value only applies if <see c_ref="IsDropShadow" /> is true.
		/// </remarks>
	...
	#region Constructors
		...
		/// <summary>
		/// Construct a <see c_ref="FontSpec"/> object with default properties.
		/// </summary>
		public FontSpec()
		...
		/// <summary>
		/// Construct a <see c_ref="FontSpec"/> object with the given properties.  All other properties
		/// are defaulted according to the values specified in the <see c_ref="Default"/>
		/// default class.
		/// </summary>
		...
		/// based on the ratio of the <see c_ref="PaneBase.Rect"/> dimension to the
		/// <see c_ref="PaneBase.BaseDimension"/> of the <see c_ref="GraphPane"/> object. </param>
		...
		/// <param name="isItalic">true for an italic typeface, false otherwise</param>
		/// <param name="isUnderline">true for an underlined font, false otherwise</param>
		/// <param name="fillColor">The <see c_ref="Color"/> to use for filling in the text background</param>
		/// <param name="fillBrush">The <see c_ref="Brush"/> to use for filling in the text background</param>
		/// <param name="fillType">The <see c_ref="ZedGraph.FillType"/> to use for the
	...
	#region Font Construction Methods
		...
		/// <param name="font">A reference to the <see c_ref="Font"/> object</param>
		...
		/// <summary>
		/// Get the <see c_ref="Font"/> class for the current scaled font.
		/// </summary>
		/// <param name="scaleFactor">
		/// The scaling factor to be used for rendering objects.  This is calculated and
		/// passed down by the parent <see c_ref="GraphPane"/> object using the
		...
		/// font sizes, etc. according to the actual size of the graph.
		/// </param>
		/// <returns>Returns a reference to a <see c_ref="Font"/> object
		/// with a size of <see c_ref="_scaledSize"/>, and font <see c_ref="Family"/>.
		/// </returns>
	...
	#region Rendering Methods
		...
		/// specified text as a power of 10, using the <see c_ref="Default.SuperSize"/>
		/// and <see c_ref="Default.SuperShift"/>.
		/// </summary>
		/// <param name="g">
		/// A graphic device object to be drawn into.  This is normally e.Graphics from the
		/// PaintEventArgs argument to the Paint() method.
	...
	#region Sizing Methods
		...
		/// <summary>
		/// Get a <see c_ref="SizeF"/> struct representing the width and height
		...
		/// the specified <see c_ref="SizeF"/> as an outer limit.
		/// </summary>
		/// <remarks>
		...
		/// </summary>
		/// <remarks>
		/// This routine differs from <see c_ref="MeasureString(Graphics,string,float)"/> in that it takes into
		...
		/// <see c_ref="Default.SuperSize"/> and <see c_ref="Default.SuperShift"/>.
		/// This routine differs from <see c_ref="MeasureString(Graphics,string,float)"/> in that it takes into
		/// account the rotation angle of the font, and gives the dimensions of the
		/// bounding box that encloses the text at the specified angle.
		/// </remarks>
