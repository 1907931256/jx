...
{
	/// <summary>
	/// An example of an <see c_ref="IPointList" /> implementation that stores large datasets, and
	/// selectively filters the output data depending on the displayed range.
	/// </summary>
	/// <remarks>
	/// This class will refilter the data points each time <see c_ref="SetBounds" /> is called.  The
	/// data are filtered down to <see c_ref="MaxPts" /> points, within the data bounds of
