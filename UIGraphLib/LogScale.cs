...
{
	/// <summary>
	/// The LogScale class inherits from the <see c_ref="Scale" /> class, and implements
	/// the features specific to <see c_ref="AxisType.Log" />.
	/// </summary>
	/// <remarks>
	/// LogScale is a non-linear axis in which the values are scaled using the base 10
	/// <see c_ref="Math.Log(double)" />
	/// function.
	/// </remarks>
	/// 
	...
	#region properties
		...
		/// </summary>
		/// <remarks>
		/// The set property is specifically adapted for <see c_ref="AxisType.Log" /> scales,
