...
namespace UIGraphLib
{
	...
	/// This class will effectively convert the data into <see c_ref="PointPair" /> objects
 ...
 * /// <summary>
		...
		/// <summary>
		/// Add a single point to the <see c_ref="RadarPointList"/> from a value of type double.
		/// </summary>
...
*/
		/// <summary>
		/// Add a single point to the <see c_ref="RadarPointList"/> from two values of type double.
		/// </summary>
		/// <param name="r">The radial coordinate value</param>
		/// <param name="z">The 'Z' coordinate value, which is not normally used for plotting,
		/// but can be used for <see c_ref="FillType.GradientByZ" /> type fills</param>
		/// <returns>The zero-based ordinal index where the point was added in the list.</returns>
