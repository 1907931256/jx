...
{
	/// <summary>
	/// A collection class containing a list of <see c_ref="ScrollRange"/> objects.
	/// </summary>
	/// 
	...
	#region List Methods
		...
		/// <summary>
		/// Indexer to access the specified <see c_ref="ScrollRange"/> object by
		/// its ordinal position in the list.
		/// </summary>
		/// <param name="index">The ordinal position (zero-based) of the
		/// <see c_ref="ScrollRange"/> object to be accessed.</param>
		/// <value>A <see c_ref="ScrollRange"/> object instance</value>
		...
		/*		/// <summary>
				/// Add a <see c_ref="ScrollRange"/> object to the collection at the end of the list.
				/// </summary>
				/// <param name="item">The <see c_ref="ScrollRange"/> object to be added</param>
				...
				/// <summary>
				/// Insert a <see c_ref="ScrollRange"/> object into the collection at the specified
				/// zero-based index location.
				/// </summary>
				/// <param name="index">The zero-based index location for insertion.</param>
				/// <param name="item">The <see c_ref="ScrollRange"/> object that is to be
				/// inserted.</param>
