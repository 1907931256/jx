...
{
	/// <summary>
	/// A collection class containing a list of <see c_ref="StockPt"/> objects
	...
	#region Properties
		...
		/// <summary>
		/// Indexer to access the specified <see c_ref="StockPt"/> object by
		/// its ordinal position in the list.
		/// </summary>
		/// <param name="index">The ordinal position (zero-based) of the
		/// <see c_ref="StockPt"/> object to be accessed.</param>
		/// <value>A <see c_ref="StockPt"/> object reference.</value>
	...
	#region Methods
		...
		/// <summary>
		/// Add a <see c_ref="StockPt"/> object to the collection at the end of the list.
		/// </summary>
		/// <param name="point">The <see c_ref="StockPt"/> object to
		/// be added</param>
		...
		/// </summary>
		/// <param name="point">The <see c_ref="PointPair"/> object to be added</param>
...
//				".  An ordinary PointPair is not allowed" );
		...
		/// <summary>
		/// Add a <see c_ref="StockPt"/> object to the collection at the end of the list using
		/// the specified values.  The unspecified values (low, open, close) are all set to
		/// <see c_ref="PointPairBase.Missing" />.
		/// </summary>
		/// <param name="date">An <see c_ref="XDate" /> value</param>
		...
		/// <summary>
		/// Access the <see c_ref="StockPt" /> at the specified ordinal index.
		/// </summary>
		/// <remarks>
		/// To be compatible with the <see c_ref="IPointList" /> interface, the
		/// <see c_ref="StockPointList" /> must implement an index that returns a
		/// <see c_ref="PointPair" /> rather than a <see c_ref="StockPt" />.  This method
		/// will return the actual <see c_ref="StockPt" /> at the specified position.
		/// </remarks>
		/// <param name="index">The ordinal position (zero-based) in the list</param>
		/// <returns>The specified <see c_ref="StockPt" />.
		/// </returns>
