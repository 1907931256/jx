...
namespace UIGraphLib
{
	...
	#region Fields
		...
		/// <see c_ref="GasGaugeNeedle"/>. Use the public property <see c_ref="Fill"/> to
		/// access this value.
		/// </summary>
		private Fill _fill;
		...
		/// <see c_ref="GasGaugeNeedle"/>
		/// </summary>
		private TextObj _labelDetail;

		/// <summary>
		/// Private field that stores the <see c_ref="Border"/> class that defines the
		/// properties of the border around this <see c_ref="GasGaugeNeedle"/>. Use the public
		/// property <see c_ref="Border"/> to access this value.
		/// </summary>
		private Border _border;

		/// <summary>
		/// The bounding rectangle for this <see c_ref="GasGaugeNeedle"/>.
		/// </summary>
		private RectangleF _boundingRectangle;

		/// <summary>
		/// Private field to hold the GraphicsPath of this <see c_ref="GasGaugeNeedle"/> to be
	...
	#region Properties
		...
		/// <summary>
		/// Gets or Sets the NeedleWidth of this <see c_ref="GasGaugeNeedle"/>
		/// </summary>
		...
		/// <summary>
		/// Gets or Sets the Border of this <see c_ref="GasGaugeNeedle"/>
		/// </summary>
		...
		/// <summary>
		/// Gets or Sets the SlicePath of this <see c_ref="GasGaugeNeedle"/>
		/// </summary>
		...
		/// <summary>
		/// Gets or Sets the LableDetail of this <see c_ref="GasGaugeNeedle"/>
		/// </summary>
		...
		/// <summary>
		/// Gets or Sets the NeedelColor of this <see c_ref="GasGaugeNeedle"/>
		/// </summary>
		...
		/// <summary>
		/// Gets or Sets the Fill of this <see c_ref="GasGaugeNeedle"/>
		/// </summary>
		public Fill Fill
		{
			get { return _fill; }
		...
		/// <summary>
		/// Private property that Gets or Sets the SweepAngle of this <see c_ref="GasGaugeNeedle"/>
		/// </summary>
		...
		/// <summary>
		/// Gets or Sets the NeedleValue of this <see c_ref="GasGaugeNeedle"/>
		/// </summary>
	...
	#region Default
		...
		/// <summary>
		/// Specify the default property values for the <see c_ref="GasGaugeNeedle"/> class.
		/// </summary>
		public struct Default
		{
			/// <summary>
			/// The default width of the gas gauge needle.  Units are points, scaled according
			/// to <see c_ref="PaneBase.CalcScaleFactor" />
			/// </summary>
			...
			/// <summary>
			/// The default border mode for GasGaugeNeedle (<see c_ref="ZedGraph.LineBase.IsVisible"/>
			/// property).
			...
			/// <summary>
			///Default value for controlling <see c_ref="GasGaugeNeedle"/> display.
			/// </summary>
			public static bool isVisible = true;

//			/// <summary>
//			/// Default value for <see c_ref="GasGaugeNeedle.LabelType"/>.
//			/// </summary>
//			public static PieLabelType LabelType = PieLabelType.Name;

			/// <summary>
			/// The default font size for <see c_ref="GasGaugeNeedle.LabelDetail"/> entries
