...
{
	/// <summary>
	/// This class handles the drawing of the curve <see c_ref="ErrorBar"/> objects.
	/// The Error Bars are the vertical lines with a symbol at each end.
	/// </summary>
	/// <remarks>To draw "I-Beam" bars, the symbol type defaults to
	/// <see c_ref="SymbolType.HDash"/>, which is just a horizontal line.
	/// If <see c_ref="BarBase"/> is Y-oriented, then the symbol type should be
	/// set to <see c_ref="SymbolType.VDash"/> to get the same effect.
	/// </remarks>
	/// 
	...
	#region Fields
		...
		/// <see c_ref="ErrorBar"/>.  Use the public
		...
		/// property <see c_ref="Color"/> to access this value.
		/// </summary>
		private Color		_color;
		/// <summary>
		/// Private field that stores the pen width for this error bar.  Use the public
		/// property <see c_ref="PenWidth"/> to access this value.
		/// </summary>
		...
		/// <see c_ref="Symbol"/> to access this value.
		/// </summary>
	...
	#region Defaults
		...
		/// default property values for the <see c_ref="ZedGraph.ErrorBar"/> class.
		/// </summary>
		public struct Default
		{
			...
			/// (<see c_ref="ZedGraph.Symbol.Size"/> property),
			/// in units of points.
			/// </summary>
			public static float Size = 7;
			/// <summary>
			/// The default pen width to be used for drawing error bars
			/// (<see c_ref="ErrorBar.PenWidth"/> property).  Units are points.
			/// </summary>
			public static float PenWidth = 1.0F;
			/// <summary>
			/// The default display mode for symbols (<see c_ref="ErrorBar.IsVisible"/> property).
			/// true to display symbols, false to hide them.
			/// </summary>
			public static bool IsVisible = true;
			/// <summary>
			/// The default color for drawing error bars (<see c_ref="ErrorBar.Color"/> property).
			/// </summary>
			public static Color Color = Color.Red;
			/// <summary>
			/// The default symbol for drawing at the top and bottom of the
			/// error bar (see <see c_ref="ErrorBar.Symbol"/>).
			/// </summary>
	...
	#region Properties
		/// <summary>
		/// Gets or sets a property that shows or hides the <see c_ref="ErrorBar"/>.
		/// </summary>
		...
		/// controlled separately by the <see c_ref="Symbol"/> property.
		/// </remarks>
	...
	#region Constructors
		/// <summary>
		/// Default constructor that sets all <see c_ref="ErrorBar"/> properties to
		...
		/// <see c_ref="ErrorBar"/> properties to default
