...
namespace UIGraphLib
{
	...
	#region Properties
		...
		/// <see c_ref="String.Empty" /> to have no title.
		/// </remarks>
		public string Title
		{
			get { return _title; }
		...
		/// </summary>
		/// <remarks>
		/// Set this value to <see c_ref="String.Empty" /> if you don't want to have
		...
		/// information associated with the <see c_ref="Link"/>.  ZedGraph does
		...
		/// <summary>
		/// Gets a value that indicates if this <see c_ref="Link" /> is enabled
		/// (see <see c_ref="IsEnabled" />), and that either the
		/// <see c_ref="Url" /> or the <see c_ref="Title" /> is non-null.
		/// </summary>
	...
	#region Constructors
		...
		/// </summary>
		/// <param name="rhs">The <see c_ref="Link"/> object from which to copy</param>
