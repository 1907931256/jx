...
namespace UIGraphLib
{
	...
	public class DataSourcePointList : IPointList
	{
		...
		/// <summary> 
		/// The <see c_ref="BindingSource" /> object from which to get the bound data 
		/// </summary> 
		/// <remarks> 
		/// Typically, you set the <see c_ref="System.Windows.Forms.BindingSource.DataSource" /> 
		/// property to a reference to your database, table or list object. The 
		/// <see c_ref="System.Windows.Forms.BindingSource.DataMember" /> property would be set 
		/// to the name of the datatable within the 
		/// <see c_ref="System.Windows.Forms.BindingSource.DataSource" />, 
		...
		/// <summary> 
		/// The <see c_ref="string" /> name of the property or column from which to obtain the 
		/// X data values for the chart. 
		/// </summary> 
		/// <remarks>Set this to null leave the X data values set to <see c_ref="PointPairBase.Missing" /> 
		/// </remarks> 
		...
		/// </summary> 
		/// <remarks>Set this to null leave the Y data values set to <see c_ref="PointPairBase.Missing" /> 
		/// </remarks> 
		...
		/// </summary> 
		/// <remarks>Set this to null leave the Z data values set to <see c_ref="PointPairBase.Missing" /> 
		/// </remarks> 
		...
		/// <see c_ref="ZedGraphControl.IsShowPointValues" /> option. 
		/// </remarks> 
		...
		/// existing <see c_ref="DataSourcePointList" /> 
		/// </summary> 
