...
{
	/// <summary>
	/// <see c_ref="YAxis"/> inherits from <see c_ref="Axis"/>, and defines the
	...
	public class YAxis : Axis, ICloneable, ISerializable
	{
		...
		/// default property values for the <see c_ref="YAxis"/> class.
		/// </summary>
		public new struct Default
		{
			// Default Y Axis properties
			/// <summary>
			/// The default display mode for the <see c_ref="YAxis"/>
			...
			/// <see c_ref="YAxis"/>, that is, a line that
		...
		/// <summary>
		/// Default constructor that sets all <see c_ref="YAxis"/> properties to
		...
		#region Methods
		/// <summary>
		/// Setup the Transform Matrix to handle drawing of this <see c_ref="YAxis"/>
		/// </summary>
		/// <param name="g">
