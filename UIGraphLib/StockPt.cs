...
namespace UIGraphLib
{
	...
	/// </summary>
	/// <remarks>
	/// The values are remapped to <see c_ref="Date" />, <see c_ref="High" />,
	/// <see c_ref="Low" />, <see c_ref="Open" />, and <see c_ref="Close" />.
	/// </remarks>
	/// 
	...
	#region Constructors
		...
		/// </summary>
		/// <param name="date">The trading date (<see c_ref="XDate" />)</param>
		...
		/// <param name="low">The daily low stock price</param>
		/// <param name="vol">The daily trading volume</param>
		/// <param name="tag">The user-defined <see c_ref="PointPair.Tag" /> property.</param>
		public StockPt( double date, double high, double low, double open, double close, double vol,
					string tag )
			: base( date, high )
		{
