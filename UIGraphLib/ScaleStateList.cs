...
{
	/// <summary>
	/// A collection class that maintains a list of <see c_ref="ScaleState" />
	/// objects, corresponding to the list of <see c_ref="Axis" /> objects
	/// from <see c_ref="GraphPane.YAxisList" /> or <see c_ref="GraphPane.Y2AxisList" />.
	/// </summary>
	public class ScaleStateList : List<ScaleState>, ICloneable
	{
		...
		/// <summary>
		/// Construct a new <see c_ref="ScaleStateList" /> automatically from an
		/// existing <see c_ref="Y2AxisList" />.
		/// </summary>
		/// <param name="list">The <see c_ref="Y2AxisList" /> (a list of Y axes),
		/// from which to retrieve the state and create the <see c_ref="ScaleState" />
		/// objects.</param>
		...
		/// </summary>
		/// <param name="rhs">The <see c_ref="ScaleStateList"/> object from which to copy</param>
