...
namespace UIGraphLib
{
	...
	#region Constructors
		...
		/// Copy constructor.
		/// </summary>
		/// <param name="rhs">The <see c_ref="MinorTic" /> that is to be copied.</param>
	...
	#region Properties
		...
		/// <summary>
		/// Calculate the scaled tic size for this <see c_ref="Axis"/>
		/// </summary>
		...
		/// <see c_ref="IsAllTics" /> = false, then activate them individually (example:
		/// <see c_ref="IsOutside" /> = true).
		/// </remarks>
		/// <seealso c_ref="IsOutside"/>
		/// <seealso c_ref="IsInside"/>
		/// <seealso c_ref="IsOpposite"/>
		/// <seealso c_ref="IsCrossInside"/>
		/// <seealso c_ref="IsCrossOutside"/>
		...
		/// </summary>
		/// <remarks>
		/// These are the tic marks on the outside of the <see c_ref="Axis"/> border.
		/// The minor tic spacing is controlled by <see c_ref="Scale.MinorStep"/>.
		/// </remarks>
		/// <value>true to show the minor outside tic marks, false otherwise</value>
		/// <seealso c_ref="Default.IsOutside"/>.
		/// <seealso c_ref="IsOutside"/>
		/// <seealso c_ref="IsInside"/>
		/// <seealso c_ref="IsOpposite"/>
		/// <seealso c_ref="IsCrossInside"/>
		...
		/// </summary>
		/// <remarks>
		/// These are the tic marks on the inside of the <see c_ref="Axis"/> border.
		/// The major tic spacing is controlled by <see c_ref="Scale.MajorStep"/>.
		/// </remarks>
		/// <value>true to show the major inside tic marks, false otherwise</value>
		/// <seealso c_ref="Default.IsInside"/>.
		/// <seealso c_ref="IsOutside"/>
		/// <seealso c_ref="IsInside"/>
		/// <seealso c_ref="IsOpposite"/>
		/// <seealso c_ref="IsCrossInside"/>
		...
		/// </summary>
		/// <remarks>
		/// These are the tic marks on the inside of the <see c_ref="Axis"/> border on
		/// the opposite side from the axis.
		/// The major tic spacing is controlled by <see c_ref="Scale.MajorStep"/>.
		/// </remarks>
		/// <value>true to show the major opposite tic marks, false otherwise</value>
		/// <seealso c_ref="Default.IsOpposite"/>.
		/// <seealso c_ref="IsOutside"/>
		/// <seealso c_ref="IsInside"/>
		/// <seealso c_ref="IsOpposite"/>
		/// <seealso c_ref="IsCrossInside"/>
		...
		/// <summary>
		/// Gets or sets the display mode for the <see c_ref="Axis"/> major outside 
		/// "cross" tic marks.
		/// </summary>
		/// <remarks>
		...
		/// to the <see c_ref="Axis.Cross" /> setting.  The other tic marks are always
		/// fixed to the edges of the <see c_ref="Chart.Rect"/>.  The cross tics
		/// are normally not displayed, since, if <see c_ref="Axis.CrossAuto" /> is true,
		/// they will exactly overlay the "normal" and "inside" tics.  If
		/// <see c_ref="Axis.CrossAuto"/> is false, then you will most likely want to
		...
		/// <summary>
		/// Gets or sets the display mode for the <see c_ref="Axis"/> major inside 
		/// "cross" tic marks.
		/// </summary>
		/// <remarks>
		/// The "cross" tics are a special, additional set of tic marks that
		...
		/// <seealso c_ref="Default.PenWidth"/>.
		/// <seealso c_ref="IsOutside"/>
		/// <seealso c_ref="Color"/>
	...
	#region Defaults
		...
		/// default property values for the <see c_ref="MinorTic"/> class.
		/// </summary>
		public struct Default
		{
			/// <summary>
			/// The default size for the <see c_ref="Axis"/> minor tic marks.
			/// (<see c_ref="MinorTic.Size"/> property). Units are in points (1/72 inch).
			/// </summary>
			public static float Size = 2.5F;
			/// <summary>
			/// The default pen width for drawing the <see c_ref="Axis"/> tic marks.
			/// (<see c_ref="MinorTic.PenWidth"/> property). Units are in points (1/72 inch).
			/// </summary>
			public static float PenWidth = 1.0F;
			/// <summary>
			/// The display mode for the <see c_ref="Axis"/> minor outside tic marks
			/// (<see c_ref="MinorTic.IsOutside"/> property).
			/// The minor tic spacing is controlled by <see c_ref="Scale.MinorStep"/>.
			/// </summary>
			...
			/// <summary>
			/// The display mode for the <see c_ref="Axis"/> minor inside tic marks
			/// (<see c_ref="MinorTic.IsInside"/> property).
			/// The minor tic spacing is controlled by <see c_ref="Scale.MinorStep"/>.
			/// </summary>
			...
			/// <summary>
			/// The display mode for the <see c_ref="Axis"/> minor opposite tic marks
			/// (<see c_ref="MinorTic.IsOpposite"/> property).
			/// The minor tic spacing is controlled by <see c_ref="Scale.MinorStep"/>.
			/// </summary>
			...
			/// <summary>
			/// The default display mode for the <see c_ref="Axis"/> minor outside 
			/// "cross" tic marks (<see c_ref="MinorTic.IsCrossOutside"/> property).
			/// </summary>
			/// <remarks>
			/// The "cross" tics are a special, additional set of tic marks that
			/// always appear on the actual axis, even if it has been shifted due
			...
			/// <summary>
			/// The default display mode for the <see c_ref="Axis"/> minor inside 
			/// "cross" tic marks (<see c_ref="MinorTic.IsCrossInside"/> property).
			/// </summary>
			/// <remarks>
			/// The "cross" tics are a special, additional set of tic marks that
			/// always appear on the actual axis, even if it has been shifted due
			...
			/// <see c_ref="Axis.CrossAuto"/> is false, then you will most likely want to
			/// enable the cross tics.
			/// The major tic spacing is controlled by <see c_ref="Scale.MinorStep"/>.
			/// </remarks>
			/// <value>true to show the major cross tic marks, false otherwise</value>
			public static bool IsCrossInside = false;

			/// <summary>
			/// The default color for minor tics (<see c_ref="MinorTic.Color"/> property).
			/// </summary>
	...
	#region Methods
		...
		/// </param>
		/// <param name="pen">Graphic <see c_ref="Pen"/> with which to draw the tic mark.</param>
		/// <param name="pixVal">The pixel location of the tic mark on this
		/// <see c_ref="Axis"/></param>
