...
namespace UIGraphLib
{
	...
	#region Printing
		...
		/// </summary>
		/// <param name="sender">The applicable <see c_ref="PrintDocument" />.</param>
		/// <param name="e">A <see c_ref="PrintPageEventArgs" /> instance providing
		...
		/// <summary>
		/// Gets or sets the <see c_ref="System.Drawing.Printing.PrintDocument" /> instance
		...
		/// <summary>
		/// Display a <see c_ref="PageSetupDialog" /> to the user, allowing them to modify
		/// the print settings for this <see c_ref="ZedGraphControl" />.
		/// </summary>
		...
		/// <summary>
		/// Display a <see c_ref="PrintDialog" /> to the user, allowing them to select a
		/// printer and print the <see c_ref="MasterPane" /> contained in this
		/// <see c_ref="ZedGraphControl" />.
		/// </summary>
		public void DoPrint()
		{
			// Add a try/catch pair since the users of the control can't catch this one
		...
		/// <summary>
		/// Display a <see c_ref="PrintPreviewDialog" />, allowing the user to preview and
		/// subsequently print the <see c_ref="MasterPane" /> contained in this
		/// <see c_ref="ZedGraphControl" />.
		/// </summary>
