...
{
	/// <summary>
	/// This class handles the drawing of the curve <see c_ref="JapaneseCandleStick"/> objects.
	/// </summary>
	/// 
	...
	#region Fields
		...
		/// <summary>
		/// Private field to store the <see c_ref="Fill" /> class to be used for filling the
		/// candlestick "bars" when the <see c_ref="StockPt.Close" /> value is greater than
		/// the <see c_ref="StockPt.Open" /> value.  See the public property
		/// <see c_ref="RisingFill" /> to access this value.
		/// </summary>
		private Fill _risingFill;
		/// <summary>
		/// Private field to store the <see c_ref="Fill" /> class to be used for filling the
		/// candlestick "bars" when the <see c_ref="StockPt.Close" /> value is less than
		/// the <see c_ref="StockPt.Open" /> value.  See the public property
		/// <see c_ref="FallingFill" /> to access this value.
		/// </summary>
		private Fill _fallingFill;

		/// <summary>
		/// Private field to store the <see c_ref="Border" /> class to be used for drawing the
		/// candlestick "bars" when the <see c_ref="StockPt.Close" /> value is greater than
		/// the <see c_ref="StockPt.Open" /> value.  See the public property
		/// <see c_ref="RisingBorder" /> to access this value.
		/// </summary>
		...
		/// candlestick "bars" when the <see c_ref="StockPt.Close" /> value is less than
		/// the <see c_ref="StockPt.Open" /> value.  See the public property
		/// <see c_ref="FallingBorder" /> to access this value.
		/// </summary>
		private Border _fallingBorder;

		/// <summary>
		/// Private field that stores the CandleStick color when the <see c_ref="StockPt.Close" /> 
		/// value is less than the <see c_ref="StockPt.Open" /> value.  Use the public
		/// property <see c_ref="FallingColor"/> to access this value.
		/// </summary>
	...
	#region Properties
		...
		/// <summary>
		/// Gets or sets the <see c_ref="Fill" /> class that is used to fill the candlestick
		/// "bars" when the <see c_ref="StockPt.Close" /> value is greater than the
		/// <see c_ref="StockPt.Open" /> value.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets the <see c_ref="Fill" /> class that is used to fill the candlestick
		/// "bars" when the <see c_ref="StockPt.Close" /> value is less than the
		/// <see c_ref="StockPt.Open" /> value.
		/// </summary>
		...
		/// <summary>
		/// The <see c_ref="Border" /> instance to be used for drawing the border frame of
		/// the candlestick "bars" when the <see c_ref="StockPt.Close" /> value is greater than the
		/// <see c_ref="StockPt.Open" /> value.
		/// </summary>
		...
		/// <summary>
		/// The <see c_ref="Border" /> instance to be used for drawing the border frame of
		/// the candlestick "bars" when the <see c_ref="StockPt.Close" /> value is less than the
		/// <see c_ref="StockPt.Open" /> value.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets the <see c_ref="System.Drawing.Color"/> data for this
		/// <see c_ref="JapaneseCandleStick"/> when the value of the candlestick is
		/// falling.
		/// </summary>
		...
		/// by the <see c_ref="LineBase.Color" /> property.
		/// </remarks>
