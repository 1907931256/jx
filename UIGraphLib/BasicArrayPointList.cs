...
{
	/// <summary>
	/// A data collection class for ZedGraph, provided as an alternative to <see c_ref="PointPairList" />.
	/// </summary>
	/// <remarks>
	/// The data storage class for ZedGraph can be any type, so long as it uses the <see c_ref="IPointList" />
	/// interface.  This class, albeit simple, is a demonstration of implementing the <see c_ref="IPointList" />
	/// interface to provide a simple data collection using only two arrays.  The <see c_ref="IPointList" />
	...
	#region Properties
		...
		/// </summary>
		/// <remarks>
		/// Returns <see c_ref="PointPairBase.Missing" /> for any value of <see paramref="index" />
