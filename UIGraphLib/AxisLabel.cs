...
namespace UIGraphLib
{
	...
	/// properties.  Inherits from <see c_ref="Label" />, and adds <see c_ref="IsOmitMag" />
	/// and <see c_ref="IsTitleAtCross" /> properties, which are specifically associated with
	/// the <see c_ref="Axis" /> <see c_ref="Axis.Title" />.
	/// </summary>
	/// 
	...
	#region Properties
		...
		/// to the end of the Axis <see c_ref="Axis.Title"/> (e.g., "(10^4)") to indicate
		...
		/// <seealso c_ref="Scale.Mag"/>
		/// <seealso c_ref="Scale.Format"/>
		...
		/// <see c_ref="Axis.Cross" />
		/// value or at the normal position (outside the <see c_ref="Chart.Rect" />).
		/// </summary>
		/// <remarks>
		/// This value only applies if <see c_ref="Axis.CrossAuto" /> is false.
		/// </remarks>
