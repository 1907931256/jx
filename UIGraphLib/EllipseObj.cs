...
namespace UIGraphLib
{
	...
	/// <see c_ref="GraphObjList"/> collection class.  The ellipse is defined
	/// as the ellipse that would be contained by the rectangular box as
	/// defined by the <see c_ref="Location"/> property.
	/// </summary>
	/// 
	...
	{
	#region Constructors
		/// <overloads>Constructors for the <see c_ref="EllipseObj"/> object</overloads>
		/// <summary>
		/// A constructor that allows the position and size
		/// of the <see c_ref="EllipseObj"/> to be pre-specified.  Other properties are defaulted.
		/// </summary>
		...
		/// of the <see c_ref="EllipseObj"/> to be pre-specified.
		/// </summary>
		...
		/// </summary>
		/// <param name="rhs">The <see c_ref="EllipseObj"/> object from
		/// which to copy</param>
