...
namespace UIGraphLib
{
	...
	/// Inherits from <see c_ref="MinorGrid" />.
	/// </summary>
	/// 
	...
	#region Constructors
		...
		/// Copy constructor
		/// </summary>
		/// <param name="rhs">The source <see c_ref="MajorGrid" /> to be copied.</param>
	...
	#region Properties
		...
		/// <see c_ref="XAxis.Default.IsZeroLine"/>, <see c_ref="YAxis.Default.IsZeroLine"/>,
		/// <see c_ref="Y2Axis.Default.IsZeroLine"/>,
		/// </remarks>
	...
	#region Defaults
		...
		/// default property values for the <see c_ref="MajorGrid"/> class.
		/// </summary>
		public new struct Default
		{
			/// <summary>
			/// The default "dash on" size for drawing the <see c_ref="Axis"/> grid
			/// (<see c_ref="MinorGrid.DashOn"/> property). Units are in points (1/72 inch).
			/// </summary>
			public static float DashOn = 1.0F;
			/// <summary>
			/// The default "dash off" size for drawing the <see c_ref="Axis"/> grid
			/// (<see c_ref="MinorGrid.DashOff"/> property). Units are in points (1/72 inch).
			/// </summary>
			public static float DashOff = 5.0F;
			/// <summary>
			/// The default pen width for drawing the <see c_ref="Axis"/> grid
			/// (<see c_ref="MinorGrid.PenWidth"/> property). Units are in points (1/72 inch).
			/// </summary>
			public static float PenWidth = 1.0F;
			/// <summary>
			/// The default color for the <see c_ref="Axis"/> grid lines
			...
			/// <summary>
			/// The default display mode for the <see c_ref="Axis"/> grid lines
