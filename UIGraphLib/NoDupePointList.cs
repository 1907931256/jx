...
namespace UIGraphLib
{
	...
	public class NoDupePointList : List<DataPoint>, IPointList, IPointListEdit
	{
		...
		/// If the data have not been filtered, then <see c_ref="Count" /> will be equal to
		/// <see c_ref="TotalCount" />.  Use the public property <see c_ref="IsFiltered" /> to
		/// access this value.
		/// </summary>
		protected bool _isFiltered;
		/// <summary>
		/// Protected field that stores the number of data points after filtering (e.g.,
		/// <see c_ref="FilterData" /> has been called).  The <see c_ref="Count" /> property
		/// returns the total count for an unfiltered dataset, or <see c_ref="_filteredCount" />
		...
		/// applies if <see c_ref="IsFiltered" /> is true.
		/// </summary>
		...
		/// neighbor in order to be filtered out.  Use the public property <see c_ref="FilterMode" />
		...
		/// have not been filtered, then <see c_ref="Count" /> will be equal to
		/// <see c_ref="TotalCount" />.
		/// </summary>
		...
		/// <see c_ref="FilterData" />).
		/// </remarks>
		/// <param name="index">The ordinal position in the list of points</param>
		/// <returns>Returns a <see c_ref="PointPair" /> instance.  The <see c_ref="PointPair.Z" />
		/// and <see c_ref="PointPair.Tag" /> properties will be defaulted to
		/// <see c_ref="PointPairBase.Missing" /> and null, respectively.
		/// </returns>
		...
		/// samples that are non-duplicates.  See the <see c_ref="TotalCount" /> property
		...
		/// <summary>
		/// Gets the total number of samples in the collection.  See the <see c_ref="Count" />
		...
		/// </summary>
		/// <param name="pt">The <see c_ref="PointPair" /> value to append</param>
		...
		/// <summary>
		/// Clears any filtering previously done by a call to <see c_ref="FilterData" />.
		/// After calling this method, all data points will be visible, and
		/// <see c_ref="Count" /> will be equal to <see c_ref="TotalCount" />.
		/// </summary>
