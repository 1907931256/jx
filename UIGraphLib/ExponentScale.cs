...
{
	/// <summary>
	/// The ExponentScale class inherits from the <see c_ref="Scale" /> class, and implements
	/// the features specific to <see c_ref="AxisType.Exponent" />.
	/// </summary>
	/// <remarks>
	/// ExponentScale is a non-linear axis in which the values are scaled using an exponential function
	/// with the <see c_ref="Scale.Exponent" /> property.
	/// </remarks>
	/// 
	...
	#region methods
		...
		/// </summary>
		/// <remarks>
		/// This method only applies to <see c_ref="AxisType.Exponent"/> type axes, and it
		/// is called by the general <see c_ref="Scale.PickScale"/> method.  The exponential scale
		/// relies on the <see c_ref="Scale.Exponent" /> property to set the scaling exponent.  This
		...
		/// <seealso c_ref="AxisType.Exponent"/>
		...
		/// <summary>
		/// Make a value label for an <see c_ref="AxisType.Exponent" /> <see c_ref="Axis" />.
		/// </summary>
		/// <param name="pane">
		/// A reference to the <see c_ref="GraphPane"/> object that is the parent or
		/// owner of this object.
