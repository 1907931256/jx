...
namespace UIGraphLib
{
	...
	#region Fields
		/// <summary>
		/// Protected field that stores the location of this <see c_ref="GraphObj"/>.
		/// Use the public property <see c_ref="Location"/> to access this value.
		/// </summary>
		protected Location _location;

		/// <summary>
		/// Protected field that determines whether or not this <see c_ref="GraphObj"/>
		/// is visible in the graph.  Use the public property <see c_ref="IsVisible"/> to
		/// access this value.
		/// </summary>
		protected bool _isVisible;
		
		/// <summary>
		/// Protected field that determines whether or not the rendering of this <see c_ref="GraphObj"/>
		/// will be clipped to the ChartRect.  Use the public property <see c_ref="IsClippedToChartRect"/> to
		/// access this value.
		/// </summary>
		...
		/// information associated with the <see c_ref="GraphObj"/>.  ZedGraph does
		...
		/// <see c_ref="ZOrder"/> to access this value.
		/// </summary>
	...
	#region Defaults
		...
		/// default property values for the <see c_ref="GraphObj"/> class.
		/// </summary>
		public struct Default
		{
			// Default text item properties
			/// <summary>
			/// Default value for the vertical <see c_ref="GraphObj"/>
			/// text alignment (<see c_ref="GraphObj.Location"/> property).
			/// This is specified
			/// using the <see c_ref="AlignV"/> enum type.
			/// </summary>
			public static AlignV AlignV = AlignV.Center;
			/// <summary>
			/// Default value for the horizontal <see c_ref="GraphObj"/>
			/// text alignment (<see c_ref="GraphObj.Location"/> property).
			/// This is specified
			...
			/// <see c_ref="GraphObj"/> location coordinates
			/// (<see c_ref="GraphObj.Location"/> property).
			/// </summary>
			...
			/// <summary>
			/// The default value for <see c_ref="GraphObj.IsClippedToChartRect"/>.
			/// </summary>
	...
	#region Properties
		/// <summary>
		/// The <see c_ref="ZedGraph.Location"/> struct that describes the location
		/// for this <see c_ref="GraphObj"/>.
		/// </summary>
		...
		/// other elements such as <see c_ref="CurveItem"/>'s, <see c_ref="Axis"/>
		/// objects, etc.  The order of <see c_ref="GraphObj"/> objects having
		/// the same <see c_ref="ZedGraph.ZOrder"/> value is controlled by their order in
		/// the <see c_ref="GraphObjList"/>.  The first <see c_ref="GraphObj"/>
		/// in the list is drawn in front of other <see c_ref="GraphObj"/>
		/// objects having the same <see c_ref="ZedGraph.ZOrder"/> value.</remarks>
		...
		/// <summary>
		/// Gets or sets a value that determines if this <see c_ref="GraphObj"/> will be
		...
		/// <summary>
		/// Gets or sets a value that determines whether or not the rendering of this <see c_ref="GraphObj"/>
		/// will be clipped to the <see c_ref="Chart.Rect"/>.
		/// </summary>
		/// <value>true to clip the <see c_ref="GraphObj"/> to the <see c_ref="Chart.Rect"/> bounds,
		...
		/// <summary>
		/// Gets or sets the hyperlink information for this <see c_ref="GraphObj" />.
		/// </summary>
		...
		/// <summary>
		/// true if the <see c_ref="ZOrder" /> of this object is set to put it in front
		/// of the <see c_ref="CurveItem" /> data points.
		/// </summary>
	...
	#region Constructors
		/// <overloads>
		/// Constructors for the <see c_ref="GraphObj"/> class.
		/// </overloads>
		/// <summary>
		/// Default constructor that sets all <see c_ref="GraphObj"/> properties to default
		...
		/// <summary>
		/// Constructor that sets all <see c_ref="GraphObj"/> properties to default
		/// values as defined in the <see c_ref="Default"/> class.
		/// </summary>
		...
		/// <summary>
		/// Constructor that creates a <see c_ref="GraphObj"/> with the specified
		/// coordinates and all other properties to defaults as specified
		/// in the <see c_ref="Default"/> class..
		/// </summary>
		/// <remarks>
		/// The four coordinates define the starting point and ending point for
		/// <see c_ref="ArrowObj"/>'s, or the topleft and bottomright points for
		/// <see c_ref="ImageObj"/>'s.  For <see c_ref="GraphObj"/>'s that only require
		...
		/// <see c_ref="ZedGraph.Location.CoordinateFrame"/> property.
		/// </remarks>
		...
		/// <summary>
		/// Constructor that creates a <see c_ref="GraphObj"/> with the specified
		/// position and <see c_ref="CoordType"/>.  Other properties are set to default
		/// values as defined in the <see c_ref="Default"/> class.
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		/// Constructor that creates a <see c_ref="GraphObj"/> with the specified
		/// position, <see c_ref="CoordType"/>, <see c_ref="AlignH"/>, and <see c_ref="AlignV"/>.
		/// Other properties are set to default values as defined in the <see c_ref="Default"/> class.
		/// </summary>
		/// <remarks>
		/// The two coordinates define the location point for the object.
		/// The units of the coordinates are specified by the
