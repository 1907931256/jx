...
namespace UIGraphLib
{
	...
	#region Constructors
		...
		/// <summary>
		/// Default constructor for <see c_ref="MajorTic" />.
		/// </summary>
		public MajorTic()
		{
			_size = Default.Size;
		...
		/// Copy constructor.
		/// </summary>
		/// <param name="rhs">The <see c_ref="MajorTic" /> that is to be copied.</param>
	...
	#region Properties
		...
		/// applicable if <see c_ref="Axis.Type"/> = <see c_ref="AxisType.Text"/>.
		/// </remarks>
		/// <value>true to place the text between the labels for text axes, false otherwise</value>
		/// <seealso c_ref="MinorTic.IsOutside"/>
		/// <seealso c_ref="MinorTic.IsInside"/>
		/// <seealso c_ref="MinorTic.IsOpposite"/>
		/// <seealso c_ref="MinorTic.IsCrossOutside"/>
		/// <seealso c_ref="MinorTic.IsCrossInside"/>
	...
	#region Defaults
		...
		public new struct Default
		{
			...
			/// <summary>
			/// The default size for the <see c_ref="Axis"/> tic marks.
			...
			/// <summary>
			/// The display mode for the <see c_ref="Axis"/> major outside tic marks
			...
			/// <summary>
			/// The display mode for the <see c_ref="Axis"/> major inside tic marks
			...
			/// <summary>
			/// The display mode for the <see c_ref="Axis"/> major opposite tic marks
			...
			/// <summary>
			/// The default display mode for the <see c_ref="Axis"/> major outside 
			...
			/// <summary>
			/// The default display mode for the <see c_ref="Axis"/> major inside 
			...
			/// <summary>
			/// The default color for major tics (<see c_ref="MinorTic.Color"/> property).
			/// </summary>
