...
namespace UIGraphLib
{
	...
	/// GraphObj objects is maintained by the <see c_ref="GraphObjList"/> collection class.
	/// </summary>
	/// <remarks>
	/// This should not be confused with the <see c_ref="LineItem" /> class, which represents
	/// a set of points plotted together as a "curve".  The <see c_ref="LineObj" /> class is
	...
	#region Fields
		...
		/// instance of the <see c_ref="LineBase" /> class.
		/// </summary>
	...
	#region Properties
		...
		/// <summary>
		/// A <see c_ref="LineBase" /> class that contains the attributes for drawing this
		/// <see c_ref="LineObj" />.
		/// </summary>
	...
	#region Constructors
		...
		/// </summary>
		/// <param name="x1">The x position of the starting point that defines the
		/// <see c_ref="LineObj"/>.  The units of this position are specified by the
		/// <see c_ref="Location.CoordinateFrame"/> property.</param>
		/// <param name="y1">The y position of the starting point that defines the
		/// <see c_ref="LineObj"/>.  The units of this position are specified by the
		/// <see c_ref="Location.CoordinateFrame"/> property.</param>
		...
		/// <summary>
		/// Default constructor -- places the <see c_ref="LineObj"/> at location
