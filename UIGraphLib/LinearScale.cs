...
{
	/// <summary>
	/// The LinearScale class inherits from the <see c_ref="Scale" /> class, and implements
	/// the features specific to <see c_ref="AxisType.Linear" />.
	/// </summary>
	/// <remarks>
	...
	#region methods
		...
		/// </summary>
		/// <remarks>
		/// This method only applies to <see c_ref="AxisType.Linear"/> type axes, and it
