...
namespace UIGraphLib
{
	...
	#region Fields
		...
		/// <summary>
		/// Private field that stores a reference to the <see c_ref="ZedGraph.Symbol"/>
		/// class defined for this <see c_ref="LineItem"/>.  Use the public
		/// property <see c_ref="Symbol"/> to access this value.
		/// </summary>
		protected Symbol	_symbol;
		/// <summary>
		/// Private field that stores a reference to the <see c_ref="ZedGraph.Line"/>
		/// class defined for this <see c_ref="LineItem"/>.  Use the public
		/// property <see c_ref="Line"/> to access this value.
		/// </summary>
	...
	#region Properties
		...
		/// <summary>
		/// Gets or sets the <see c_ref="ZedGraph.Symbol"/> class instance defined
		/// for this <see c_ref="LineItem"/>.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets the <see c_ref="ZedGraph.Line"/> class instance defined
		/// for this <see c_ref="LineItem"/>.
		/// </summary>
		public Line Line
		{
	...
	#region Constructors
		/// <summary>
		/// Create a new <see c_ref="LineItem"/>, specifying only the legend <see c_ref="CurveItem.Label" />.
		/// </summary>
		...
		/// <summary>
		/// Create a new <see c_ref="LineItem"/> using the specified properties.
		/// </summary>
		/// <param name="label">The _label that will appear in the legend.</param>
		...
		/// </param>
		/// <param name="symbolType">A <see c_ref="SymbolType"/> enum specifying the
		...
		/// </summary>
		/// <param name="rhs">The <see c_ref="LineItem"/> object from which to copy</param>
	...
	#region Methods
		/// <summary>
		/// Do all rendering associated with this <see c_ref="LineItem"/> to the specified
		...
		/// <summary>
		/// Draw a legend key entry for this <see c_ref="LineItem"/> at the specified location
		/// </summary>
		/// <param name="g">
		/// A graphic device object to be drawn into.  This is normally e.Graphics from the
		/// PaintEventArgs argument to the Paint() method.
