...
Public Class ExportManager
    ...
    Public Function ExportPatientUse(ByVal dt As DataTable, ByVal strName As String) As Boolean
        m_lstDataFromProcedure.Clear()
        m_strFileName = strName
        Dim strPath As String = SetXmlPath(TEXT_EXPORT_PATIENTUSE)
        Try
    ...
    Public Function ExportReadyDispatchStatistic(ByVal dt As DataTable, ByVal strName As String) As Boolean
        m_lstDataFromProcedure.Clear()
        m_strFileName = strName
        Dim strPath As String = SetXmlPath(TEXT_EXPORT_READY_DISPATCH_STATISTIC)
        Try
            ExportExcel(strPath, dt)
        Catch ex As Exception
            m_strErrorMessage = ex.Message
