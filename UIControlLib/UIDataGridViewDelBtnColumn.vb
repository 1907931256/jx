...
Public Class UIDataGridViewDelBtnColumn
    Inherits DataGridViewButtonColumn
    'Constructer
    Public Sub New()
        Me.CellTemplate = New UIDataGridViewDelBtnCell()
    End Sub
    ...
    Public Overrides Property CellTemplate() As DataGridViewCell
        ...
        Set(ByVal value As DataGridViewCell)
            If Not TypeOf value Is UIDataGridViewDelBtnCell Then
...
Public Class UIDataGridViewDelBtnCell
    ...
    Protected Overrides Sub Paint(ByVal graphics As Graphics, _
        ...
        Dim img As Image = My.Resources.text_normal
        If m_emImageType = IMAGE_TYPE.OVER Then img = My.Resources.text_over
        If m_emImageType = IMAGE_TYPE.PRESS Then
            img = My.Resources.text_press
            iIndent = 1
        End If
